...
const EXPLICIT_TAXONOMY_DECISIONS: readonly ResearchTaxonomyDecision[] = [
  ...
  decision(
    ...
    "source-backed-contested",
    ["source-sep-environmental-ethics", "source-cambridge-ecologism", "source-trumpeter-drengson-devall-deep-ecology", "source-mit-katz-light-rothenberg-deep-ecology", "source-wiley-grey-deep-ecology-critique", "source-cambridge-dizerega-deep-ecology-liberalism", "source-uksw-bombik-deep-ecology-methodology", "source-sage-luke-deep-ecology"],
    "The source comparison treats Deep Ecology as a plural philosophical and movement platform: Naessian ecosophy, platform principles, policy formulations, and concrete actions are related but not identical, and critical scholarship disputes its paradigm, science, technology, and political translations.",
    "Keep it queryable and researchable as associated context, but do not force it into the political-ideology hierarchy or infer a political identity from ecological philosophy, environmental concern, wilderness preference, localism, decentralization, or one policy alone.",
    ["Some ecological movements and political theorists treat Deep Ecology as politically consequential.", "Its platform principles can be supported from diverse worldviews and produce plural policy or action routes.", "A future contextual split must not duplicate Ecologism, Bioregionalism, Social Ecology, Green Anarchism, or Anarcho-Primitivism merely because their ecological vocabulary overlaps."],
    "registry-only",
    "not-scored",
    "2026-08-29",
  ),
