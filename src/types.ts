...
export type BeliefDirectEvidenceKind = "conception" | "moral-scope" | "causal-account" | "legitimacy-basis" | "distributive-reason" | "institutional-route" | "political-economy" | "change-path" | "change-mechanism" | "transition-standard" | "priority-rule" | "epistemic-stance" | "contestation-response";
