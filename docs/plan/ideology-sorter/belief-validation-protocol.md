...
| Direct categorical item | A respondent can select among explicitly stated conceptions or accounts and the selected option has the declared meaning. | Eleven optional direct pilot items are effect-free and excluded from affinity calculation. |
