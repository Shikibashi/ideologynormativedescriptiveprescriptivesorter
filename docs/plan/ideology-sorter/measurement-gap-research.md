...
## V147 — direct categorical coverage of the remaining candidate-only claim-layer cells — 2026-08-30

The research shelf already declared ten candidate-only cells where the production bank has no item for a construct/layer pair. V147 adds seven optional direct categorical records for the cells not covered by V146: prescriptive concept-conception, normative political-economy justice, descriptive change mechanism, normative change-transition standard, prescriptive rights-versus-local-autonomy priority, normative fact/value distinction, and normative heterodoxy revision. The records adapt the existing source-backed candidates rather than adding new constructs or ideology nodes. Their alternatives are grounded in the existing source register: Freeden on contested conceptual morphology, Rawls and Sen on justice and capabilities, republicanism and liberalism on liberty and economic power, North, Pierson, and Tilly on institutional and organizational change, Dahl and Ostrom on participation and local self-government, and AAPOR plus the measurement-method sources for neutral wording and explicit missingness.

The seven records are categorical direct evidence with four substantive alternatives and `No view yet`; they remain outside `DATASET.questions`, `Question.effects`, the legacy scorer, morphology affinity, anchor ordering, and ontology placement. The three entirely production-unmeasured constructs remain `unmeasured`, and all ten candidate-only cells remain candidate-only in the production-versus-research matrix. The direct-pilot and completion audits now prove that every candidate-only cell has a corresponding direct pilot item without treating that coverage as production measurement. The queue therefore expands to 1,543 records: 1,500 production audits, 19 quarantined candidates, 18 direct items, and six relational follow-ups.

The local acceptance condition is source and option provenance for all seven items, valid synthetic direct evidence for all 18 pilot records, share restoration, profile/morphology trace retention, unchanged legacy and affinity outputs, zero production-id overlap, and green deterministic/browser checks. No cognitive review or respondent study is performed in this tranche. The six external validation gates remain `NOT RUN`, promotion remains false, and local structural evidence is not a substitute for expert adjudication, response-process evidence, empirical validity/reliability, cross-context invariance, population/consequence review, or held-out respondent morphology.

## V148 — candidate-specific direct-pilot traceability — 2026-08-30

The nineteen quarantined research candidates now each have exactly one optional direct categorical pilot record. V148 adds twelve records for the remaining priority, epistemic, and heterodoxy candidates: four priority-conflict rules, four descriptive epistemic-stance records, and four heterodoxy/contestation responses. The seven V147 records retain their candidate lineage, so the direct pilot covers all nineteen candidates without adding a new ideology node, construct, production question, effect, or scoring coefficient. Each new record has four source-linked substantive options plus explicit `No view yet` missingness; the candidate link is checked against the item's declared construct, claim layer, and complete candidate source set.

This is a provenance and authoring traceability improvement, not a promotion step. The thirty direct records remain outside `DATASET.questions`, `Question.effects`, scalar `BeliefObservation` aggregation, legacy scoring, morphology affinity, anchor ordering, and ontology governance. Selected options remain visible only as non-scoring direct evidence in the profile and morphology trace. The production audit therefore continues to report 1,500 `facet-proxy` questions, the three production-unmeasured constructs, and all ten candidate-only construct/layer cells. The dynamic review queue is now 1,555 records: 1,500 production audits, 19 quarantined candidates, 30 direct pilot definitions, and six relational follow-ups.

The local acceptance condition is exact one-to-one lineage coverage for the nineteen candidate ids, source and option validation, synthetic evidence for all thirty direct records, unchanged legacy and affinity outputs, profile/morphology trace retention, share restoration, and stable browser selection. The completion audit remains structurally eligible but overall `INCOMPLETE` while the six external gates are `NOT RUN`. No cognitive review, expert adjudication, respondent study, psychometric validation, invariance study, population/consequence review, or held-out respondent-morphology study is performed or implied by this tranche.
