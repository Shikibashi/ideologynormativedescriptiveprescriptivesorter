...
## v59 methodology continuation — Qutbism micro branch

V59 preserves descriptive, normative, and prescriptive claim layers while adding source-bounded coverage for the existing `Islamism → Qutbism` micro branch. Toth, Khatab, Faradj, Wagemakers, and existing Qutb/Islamism records support terminology and variation around divine sovereignty, `jahiliyya`, comprehensive moral order, disciplined community, authority, pluralism, and revolutionary/reformist reception. The twelve prompts use only facets valid for their respective layer; the anchor is provisional editorial geometry, not a validated scale or classifier.

The dataset contains 1,044 prompts (348 per layer), 86 editorial anchors, 81 scoring anchors, 1,428 effect-free candidates, and 119 targets. Taxonomy promotion is separate from measurement activation. No cognitive, respondent, simulation, psychometric, reliability/validity, invariance, empirical, or population evidence was run.

## v60 methodology continuation — Radical Republicanism micro branch

V60 preserves descriptive, normative, and prescriptive claim layers while adding source-bounded coverage for the existing `Republicanism → Historical Republicanism → Radical Republicanism` micro branch. The Oxford radical-republican volume, Pettit's non-domination treatment, Urbinati's republican-democracy analysis, Thompson's radical-republican reading of Marx, and existing republican records support terminology and variation around popular sovereignty, non-domination, civic equality, anti-corruption, contestation, material independence, and institutional transformation. The twelve prompts use only facets valid for their respective layer; the anchor is provisional editorial geometry, not a validated scale or classifier.

The dataset contains 1,056 prompts (352 per layer), 87 editorial anchors, 82 scoring anchors, 1,428 effect-free candidates, and 119 targets. The canonical inventory remains 9 macro / 33 canonical meso / 60 canonical micro, with five contextual placements and 12 registry entries outside production scoring; ontology-level totals remain 9/38/60. Radical Republicanism has twelve direct target-tagged items and isolated 4/4/4 routing. Full-competition ranks and top-three fields remain deterministic geometry diagnostics only; no cognitive review, respondent study, substitute simulation, psychometric calibration, reliability/validity, invariance, empirical, or population evidence is claimed.

## V61 — Marxist Feminism micro branch

V61 preserves the three claim layers while adding source-bounded coverage for the existing `Socialist / Marxist Feminism → Marxist Feminism` micro branch. Arruzza, Boris and Swinth, Battistoni, Ferguson, Bhattacharya, and Farris, and the existing feminist sources support terminology and variation around class-gender power, capitalist production, social reproduction, labor, care, material dependence, and transformation. The twelve prompts use only facets valid for their respective layer; the anchor is provisional editorial geometry, not a validated scale or classifier.

The dataset contains 1,068 prompts (356 per layer), 88 editorial anchors, 83 scoring anchors, 1,428 effect-free candidates, and 119 targets. The canonical inventory remains 9 macro / 33 canonical meso / 60 canonical micro, with five contextual placements and 12 registry entries outside production scoring; ontology-level totals remain 9/38/60. Marxist Feminism has twelve direct target-tagged items and isolated 4/4/4 routing. Full-competition ranks and top-three fields remain deterministic geometry diagnostics only; no cognitive review, respondent study, substitute simulation, psychometric calibration, reliability/validity, invariance, empirical, or population evidence is claimed.

## V62 — Socialist Feminism micro branch

V62 preserves the three claim layers while adding source-bounded coverage for the existing `Socialist / Marxist Feminism → Socialist Feminism` micro branch. Hennessy, Cantillon, Mackett, Stevano, Dean, and Maiguashca support terminology and variation around patriarchy and class, production and social reproduction, paid and unpaid labor, care, collective provision, socialist transformation, and autonomous or institutional organizing. The twelve prompts use only facets valid for their respective layer; the anchor is provisional editorial geometry, not a validated scale or classifier.

The dataset contains 1,080 prompts (360 per layer), 89 editorial anchors, 84 scoring anchors, 1,428 effect-free candidates, and 119 targets. The canonical inventory remains 9 macro / 33 canonical meso / 60 canonical micro, with five contextual placements and 12 registry entries outside production scoring; ontology-level totals remain 9/38/60. Socialist Feminism has twelve direct target-tagged items and isolated 4/4/4 routing. Full-competition ranks and top-three fields remain deterministic geometry diagnostics only; no cognitive review, respondent study, substitute simulation, psychometric calibration, reliability/validity, invariance, empirical, or population evidence is claimed.

## V63 — Left-Wing Populism micro branch

V63 preserves the three claim layers while adding source-bounded coverage for the existing `Populism → Left-Wing Populism` micro branch. Saalfeld, Eklundh, Stengel, Wojczewski, Venizelos, and Stavrakakis support terminology and variation around people-centrism, anti-elitism, left-egalitarian host content, identity construction, institutional strategy, leadership, movement organization, and domestic or international routes. The twelve prompts use only facets valid for their respective layer; the anchor is provisional editorial geometry, not a validated scale or classifier.

The dataset contains 1,092 prompts (364 per layer), 90 editorial anchors, 85 scoring anchors, 1,428 effect-free candidates, and 119 targets. The canonical inventory remains 9 macro / 33 canonical meso / 60 canonical micro, with five contextual placements and 12 registry entries outside production scoring; ontology-level totals remain 9/38/60. Left-Wing Populism has twelve direct target-tagged items and isolated 4/4/4 routing. Full-competition ranks and top-three fields remain deterministic overlap diagnostics only; no cognitive review, respondent study, substitute simulation, psychometric calibration, reliability/validity, invariance, empirical, or population evidence is claimed.

## V64 — Neoconservatism micro branch

V64 preserves descriptive, normative, and prescriptive claim layers while adding source-bounded coverage for the existing `Conservatism → Neoconservatism` micro branch. Feldman, Hull, and Williams, alongside existing conservatism and political-ideologies sources, support terminology and variation around moral-order critique, republican-democratic common purpose, civic virtue, public authority, national interest, and international engagement. The twelve prompts use only facets valid for their respective layer; the anchor is provisional editorial geometry, not a validated scale or classifier.

The dataset contains 1,104 prompts (368 per layer), 91 editorial anchors, 86 scoring anchors, 1,428 effect-free candidates, and 119 targets. The canonical inventory remains 9 macro / 33 canonical meso / 60 canonical micro, with five contextual placements and 12 registry entries outside production scoring; ontology-level totals remain 9/38/60. Neoconservatism has twelve direct target-tagged items and isolated 4/4/4 routing. Full-competition ranks and top-three fields remain deterministic overlap diagnostics only; no cognitive review, respondent study, substitute simulation, psychometric calibration, reliability/validity, invariance, empirical, or population evidence is claimed.
## V65 — Paleoconservatism micro branch

V65 preserves descriptive, normative, and prescriptive claim layers while adding source-bounded coverage for the existing Conservatism → Paleoconservatism micro branch. Dougall, Bartee, and Kolozi support terminology and variation around post-war New Right formation, national particularity and sovereignty, inherited culture and local authority, restraint toward centralized or globalizing projects, and critique of universalizing or market-globalist arrangements. The twelve prompts use only facets valid for their respective layer; the anchor is provisional editorial geometry, not a validated scale or classifier.

The dataset contains 1,116 prompts (372 per layer), 92 editorial anchors, 87 scoring anchors, 1,428 effect-free candidates, and 119 targets. The canonical inventory remains 9 macro / 33 canonical meso / 60 canonical micro, with five contextual placements and 12 registry entries outside production scoring; ontology-level totals remain 9/38/60. Paleoconservatism has twelve direct target-tagged items and isolated 4/4/4 routing. Full-competition ranks and top-three fields remain deterministic overlap diagnostics only; no cognitive review, respondent study, substitute simulation, psychometric calibration, reliability/validity, invariance, empirical, or population evidence is claimed.

## V66 — Wasatiyya micro branch

V66 preserves descriptive, normative, and prescriptive claim layers while adding source-bounded coverage for the existing `Islamism → Wasatiyya` micro branch. Browers, Kazmi, Sakthivel, and Teitelbaum and Abdulaev support terminology and variation around a contested middle-way or centrist Islamist current, modernity, participation, citizenship, coexistence, public moral order, theological boundaries, and relationships to secular pluralism and violence. The twelve prompts use only facets valid for their respective layer; the anchor is provisional editorial geometry, not a validated scale or classifier.

The dataset contains 1,128 prompts (376 per layer), 93 editorial anchors, 88 scoring anchors, 1,428 effect-free candidates, and 119 targets. The canonical inventory remains 9 macro / 33 canonical meso / 60 canonical micro, with five contextual placements and 12 registry entries outside production scoring; ontology-level totals remain 9/38/60. Wasatiyya has twelve direct target-tagged items and isolated 4/4/4 routing. Full-competition ranks and top-three fields remain deterministic overlap diagnostics only; no cognitive review, respondent study, substitute simulation, psychometric calibration, reliability/validity, invariance, empirical, or population evidence is claimed.

## V67 — Right-Wing Populism micro branch

V67 preserves the three claim layers while adding source-bounded coverage for the existing Populism → Right-Wing Populism micro branch. Meijers, Huber, and Zaslove, Praet, and Hidalgo support terminology and variation around the people-versus-elite mechanism, right-wing national or culturally conservative hosts, and the separation of populism from nativism, nationalism, and authoritarianism. The twelve prompts use only facets valid for their respective layer; the anchor is provisional editorial geometry, not a validated scale or classifier.

The dataset contains 1,140 prompts (380 per layer), 94 editorial anchors, 89 scoring anchors, 1,428 effect-free candidates, and 119 targets. The canonical inventory remains 9 macro / 33 canonical meso / 60 canonical micro, with five contextual placements and 12 registry entries outside production scoring; ontology-level totals remain 9/38/60. Right-Wing Populism has twelve direct target-tagged items and isolated 4/4/4 routing. Full-competition ranks and top-three fields remain deterministic overlap diagnostics only; no cognitive review, respondent study, substitute simulation, psychometric calibration, reliability/validity, invariance, empirical, or population evidence is claimed.
## V68 — Hindutva micro branch

V68 preserves descriptive, normative, and prescriptive claim layers while adding source-bounded coverage for the existing `Religious Nationalism → Hindutva (Hindu Nationalism)` micro branch. Mehta, Sarkar, and Brass support terminology and variation around Hindu civilizational or cultural nationhood, historical memory, majority/minority membership, caste and internal diversity, public authority, institutional translation, and contested Hindu Rashtra/Hindu Rajya and secular equal-citizenship routes. The twelve prompts use only facets valid for their respective layer; the anchor is provisional editorial geometry, not a validated scale or classifier.

The dataset contains 1,152 prompts (384 per layer), 95 editorial anchors, 90 scoring anchors, 1,428 effect-free candidates, and 119 targets. The canonical inventory remains 9 macro / 33 canonical meso / 60 canonical micro, with five contextual placements and 12 registry entries outside production scoring; ontology-level totals remain 9/38/60. Hindutva has twelve direct target-tagged items and isolated 4/4/4 routing. Full-competition ranks and top-three fields remain deterministic overlap diagnostics only; no cognitive review, respondent study, substitute simulation, psychometric calibration, reliability/validity, invariance, empirical, or population evidence is claimed.


## V69 — Religious Zionism micro branch

V69 preserves descriptive, normative, and prescriptive claim layers while adding source-bounded coverage for the existing `Religious Nationalism → Religious Zionism` micro branch. Schwartz, Yadgar and Hadad, Novak, and Rubin support terminology and variation around religious interpretation, Jewish peoplehood and self-determination, public/state institutions, constitutional democracy, territorial and diaspora questions, and historical or organizational variation. The twelve prompts use only facets valid for their respective layer; the anchor is provisional editorial geometry, not a validated scale or classifier.

The dataset contains 1,164 prompts (388 per layer), 96 editorial anchors, 91 scoring anchors, 1,428 effect-free candidates, and 119 targets. The canonical inventory remains 9 macro / 33 canonical meso / 60 canonical micro, with five contextual placements and 12 registry entries outside production scoring; ontology-level totals remain 9/38/60. Religious Zionism has twelve direct target-tagged items and isolated 4/4/4 routing. Full-competition ranks and top-three fields remain deterministic overlap diagnostics only; no cognitive review, respondent study, substitute simulation, psychometric calibration, reliability/validity, invariance, empirical, or population evidence is claimed.

## V70 — Neo-Fascism meso branch

V70 preserves descriptive, normative, and prescriptive claim layers while adding source-bounded coverage for the existing Fascism → Neo-Fascism meso branch. Bull, Wolff, Albanese, and Forlenza support a historically situated post-1945 field of fascist continuities, adaptations, and revivals, with internal variation over democracy, corporatism, organization, state power, sovereignty, country, generation, and transnational form. The twelve prompts use only facets valid for their respective layer; the anchor is provisional editorial geometry, not a validated scale or classifier.

The dataset contains 1,176 prompts (392 per layer), 97 editorial anchors, 92 scoring anchors, 1,428 effect-free candidates, and 119 targets. The canonical inventory remains 9 macro / 33 canonical meso / 60 canonical micro, with five contextual placements and 12 registry entries outside production scoring; ontology-level totals remain 9/38/60. Neo-Fascism has twelve direct target-tagged items and isolated 4/4/4 routing. Full-competition ranks and top-three fields remain deterministic overlap diagnostics only; no cognitive review, respondent study, substitute simulation, psychometric calibration, reliability/validity, invariance, empirical, or population evidence is claimed.
