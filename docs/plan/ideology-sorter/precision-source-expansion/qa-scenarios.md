...
## v64 precision QA scenarios — Neoconservatism micro branch
...
## v65 precision QA scenarios — Paleoconservatism micro branch
...
## v67 precision QA scenarios — Right-Wing Populism micro branch

| ID | Scenario | Expected result |
|---|---|---|
| P-67-01 | Inspect source and ontology metadata. | Existing Populism → Right-Wing Populism path, five direct sources including two fresh academic records, two discriminants, a profile, and no topology change. |
...
## v68 precision QA scenarios — Hindutva micro branch

| ID | Action | Expected evidence |
|---|---|---|
| P-68-01 | Inspect source and ontology metadata. | Existing Religious Nationalism → Hindutva (Hindu Nationalism) path, six direct source references including three fresh academic records, two discriminants, and no topology change. |
...
| P-69-02 | Inspect direct items and sources. | Twelve target-tagged prompts appear at 4/4/4, each with the Religious Zionism analytical context and all four fresh academic source records. |
...
| P-69-04 | Inspect governance and false-positive metadata. | Governance shows retain-canonical/scored-provisional and the workbench shows dedicated-and-scored as separate states; identity, private faith, broad Zionism, current policy, and current-conflict inference are guarded. |
...
| P-70-02 | Inspect direct items and sources. | Twelve target-tagged prompts appear at 4/4/4, each with the Neo-Fascism analytical context and all four fresh academic source records. |
...
## V87 QA scenarios — Flemish / Belgian Fascism historical microtype

| ID | Scenario | Expected evidence |
|---|---|---|
| P-87-01 | Run research coverage and dataset validation. | 1,380 prompts at 460 per layer; 114 editorial anchors; 109 production anchors; 114 ontology nodes with canonical inventory 9/33/67; 5 registry entries; 1,428 candidates across 119 targets; zero validation errors. |
| P-87-02 | Inspect the Flemish / Belgian Fascism target. | Canonical `Fascism → Flemish / Belgian Fascism` micro path; dedicated-scored state; 12 direct items at 4/4/4; nine direct source references; four neighbors; 17-dimension profile; false-positive audit; and promote-to-canonical governance. |
...
| P-90-01 | Run research coverage and dataset validation after the Civic Republicanism source refresh. | Counts remain 1,404 prompts at 468 per layer, 116 editorial anchors, 111 production anchors, 116 ontology nodes, 3 registry entries, 1,428 candidates across 119 targets, and zero validation errors. |
| P-90-02 | Inspect Civic Republicanism's research target and governance decision. | The target remains a registry entry with registry-only/not-scored status, has refreshed academic provenance and existing effect-free candidates, has no canonical node or production questions, and records explicit `retain-registry-only` governance dated 2026-08-29. |
| P-91-01 | Run research coverage and dataset validation after the Conservative New Right source refresh. | Counts remain content version 89 with 1,404 prompts at 468 per layer, 116 editorial anchors, 111 production anchors, 116 ontology nodes, 3 registry entries, 1,428 candidates across 119 targets, and zero validation errors. |
| P-91-02 | Inspect Conservative New Right's source-backed contextual boundary and governance decision. | The target remains a `contextual-formation` registry entry with registry-only/not-scored status, six fresh academic sources, twelve effect-free candidates, no canonical node or production questions, a seven-dimension profile, three neighbor discriminants, and explicit `retain-registry-only` governance dated 2026-08-29. |
| P-92-01 | Run research coverage and dataset validation after the Deep Ecology source refresh. | Counts remain content version 89 with 1,404 prompts at 468 per layer, 116 editorial anchors, 111 production anchors, 116 ontology nodes, 3 registry-only targets, 1,428 candidates across 119 targets, and zero validation errors. |
| P-92-02 | Inspect Deep Ecology's source-backed associated-framework boundary and governance decision. | The target remains an `associated-tradition` registry entry with registry-only/not-scored status, six fresh academic sources, twelve effect-free candidates, no canonical node or production questions, a twelve-dimension existing-facet profile, four neighbor discriminants, and explicit `demote-to-associated` governance dated 2026-08-29. |

| P-93-01 | Run research coverage and dataset validation after the Georgism promotion. | Content version 90; 1,416 prompts at 472 per layer; 117 ontology nodes with 9 macro / 39 meso / 69 micro counts; 112 canonical placements; 3 registry entries; 5 contextual placements; 1,440 candidates across 120 targets; and zero validation errors. |
| P-93-02 | Inspect Georgism's canonical meso target and governance decision. | A parentless canonical `Georgism` meso node with provisional dedicated-scored status, a provisional anchor, eight source references, twelve direct items at 4/4/4, twelve quarantined candidates at 4/4/4, a thirteen-dimension existing-facet profile, four neighbor discriminants, a false-positive audit, and explicit `promote-to-canonical` governance dated 2026-08-29. |
| P-93-03 | Run isolated anchor reachability and full fixture diagnostics for Georgism. | Georgism reaches every layer in the isolated-anchor fixture with no structural failure; full-production overlap is retained as deterministic geometry evidence only and does not trigger uncalibrated scorer or picker retuning. |
| P-93-04 | Inspect the Georgism boundary and schema gap. | Direct items require convergent land/location value, rent, natural opportunity, labor/improvement, and institutional-route content; generic tax reform, property support, agrarian identity, environmental concern, infrastructure support, one policy, or identity alone is insufficient; no dedicated land/rent facet is invented. |
| P-93-05 | Run delivery and browser checks. | TypeScript, focused/full Vitest, build, high-severity audit, coverage, reachability, Compose/Docker, `/healthz`, serial local/Docker Playwright, and diff hygiene pass; no cognitive, respondent, psychometric, or empirical claim. |

## V94 QA scenarios — Degrowth ecological-economic meso promotion

| ID | Scenario | Expected evidence |
|---|---|---|
| P-94-01 | Run research coverage and dataset validation after the Degrowth promotion. | Content version 91; 1,428 prompts at 476 per layer; 118 editorial anchors; 113 production anchors; 118 ontology nodes with 9 macro / 40 meso / 69 micro counts; 3 registry entries; 5 contextual placements; 1,452 candidates across 121 targets; and zero validation errors. |
| P-94-02 | Inspect Degrowth's canonical meso target and governance decision. | A parentless canonical `Degrowth` meso node with provisional dedicated-scored status, a provisional anchor, eight source references, twelve direct items at 4/4/4, twelve quarantined candidates at 4/4/4, a fifteen-dimension existing-facet profile, six neighbor discriminants, a false-positive audit, and explicit `promote-to-canonical` governance dated 2026-08-29. |
| P-94-03 | Run isolated anchor reachability and full fixture diagnostics for Degrowth. | Degrowth reaches every layer in the isolated-anchor fixture with no structural failure; full-production overlap is retained as deterministic geometry evidence only and does not trigger uncalibrated scorer or picker retuning. |
| P-94-04 | Inspect the Degrowth boundary and schema gap. | Direct items require convergent growth/throughput, ecological-cost or limits, sufficiency/wellbeing, justice, democratic, and institutional-route content; generic environmental concern, frugality, recession/austerity, anti-capitalism, localism, anti-technology, wellbeing-economy language, one policy, or one actor is insufficient; no dedicated growth/throughput facet is invented. |
| P-94-05 | Run complete-answer share round trip. | Versioned v2 fragment measures 15,857 characters, remains below the finite limit, and decodes to the complete answer map. |
| P-94-06 | Run delivery and browser checks. | TypeScript, focused/full Vitest, build, high-severity audit, coverage, reachability, Compose/Docker, `/healthz`, serial local/Docker Playwright, and diff hygiene pass; no cognitive, respondent, psychometric, or empirical claim. |

## V95 QA scenarios — Distributism canonical meso promotion

| ID | Scenario | Expected evidence |
|---|---|---|
| P-95-01 | Run research coverage and dataset validation after the Distributism promotion. | Content version 92; 1,440 prompts at 480 per layer; 119 editorial anchors; 114 production anchors; 119 ontology nodes with 9 macro / 41 meso / 69 micro counts; 3 registry entries; 5 contextual placements; 1,464 candidates across 122 targets; and zero validation errors. |
| P-95-02 | Inspect Distributism's canonical meso target and governance decision. | A parentless canonical `Distributism` meso node with provisional dedicated-scored status, a provisional anchor, eight source references, twelve direct items at 4/4/4, twelve quarantined candidates at 4/4/4, a fifteen-dimension existing-facet profile, six neighbor discriminants, a false-positive audit, and explicit `promote-to-canonical` governance dated 2026-08-29. |
| P-95-03 | Run isolated anchor reachability and full fixture diagnostics for Distributism. | Distributism reaches every layer in the isolated-anchor fixture with no structural failure; full-production overlap is retained as deterministic geometry evidence only and does not trigger uncalibrated scorer or picker retuning. |
| P-95-04 | Inspect the Distributism boundary and schema gap. | Direct items require convergent wide-ownership or material-independence, common-good and work, intermediate-association, and subsidiarity or anti-concentration content; Catholic identity, family traditionalism, small firms, localism, cooperatives alone, private-property defense, anti-capitalism, anti-monopoly policy, agrarian identity, one ownership design, or one actor is insufficient; no dedicated property-dispersion or association facet is invented. |
| P-95-05 | Run complete-answer share round trip. | Versioned v2 fragment measures 16,001 characters, remains below the finite limit, and decodes to the complete answer map. |
| P-95-06 | Run delivery and browser checks. | TypeScript, focused/full Vitest, build, high-severity audit, coverage, reachability, Compose/Docker, `/healthz`, serial local/Docker Playwright, and diff hygiene pass; no cognitive, respondent, psychometric, or empirical claim. |

## V96 QA scenarios — Christian Socialism canonical meso promotion

| ID | Scenario | Expected evidence |
|---|---|---|
| P-96-01 | Run research coverage and dataset validation after the Christian Socialism promotion. | Content version 93; 1,452 prompts at 484 per layer; 120 editorial anchors; 115 production anchors; 120 ontology nodes with 9 macro / 42 total meso / 69 micro placements and 9 macro / 37 canonical meso / 69 micro inventory; 3 registry entries; 5 contextual placements; 1,476 candidates across 123 targets; and zero validation errors. |
| P-96-02 | Inspect Christian Socialism's canonical meso target and governance decision. | A parentless canonical `Christian Socialism` meso node with provisional dedicated-scored status, a provisional anchor, eight source references, twelve direct items at 4/4/4, twelve quarantined candidates at 4/4/4, a fifteen-dimension existing-facet profile, six neighbor discriminants, a false-positive audit, and explicit `promote-to-canonical` governance dated 2026-08-29. |
| P-96-03 | Run isolated anchor reachability and full fixture diagnostics for Christian Socialism. | Christian Socialism reaches every layer in the isolated-anchor fixture with no structural failure; full-production overlap is retained as deterministic geometry evidence only and does not trigger uncalibrated scorer or picker retuning. |
| P-96-04 | Inspect the Christian Socialism boundary and schema gap. | Direct items require convergent Christian moral or theological grounding, socialist structural critique, solidarity, collective economic transformation, and an institutional route; private piety, charity, generic social concern, Christian Democracy, Distributism, one denomination, one author, one movement, one party, or one policy is insufficient; no dedicated religious-socialism or theological-grounding facet is invented. |
| P-96-05 | Run complete-answer share round trip. | Versioned v2 fragment measures 16,145 characters, remains below the finite limit, and decodes to the complete answer map. |
| P-96-06 | Run delivery and browser checks. | TypeScript, focused/full Vitest, build, high-severity audit, coverage, reachability, Compose/Docker, `/healthz`, and Docker-backed Playwright pass; no cognitive, respondent, psychometric, or empirical claim. |

## V97 QA scenarios — Ujamaa / Nyererean African Socialism canonical meso promotion

| ID | Scenario | Expected evidence |
|---|---|---|
| P-97-01 | Run research coverage and dataset validation after the Ujamaa promotion. | Content version 94; 1,464 prompts at 488 per layer; 116 production/scored anchors and 121 editorial anchors; 121 ontology nodes with 9 macro / 43 total meso / 69 micro placements and 9 macro / 38 canonical meso / 69 micro inventory; 3 registry entries; 5 contextual placements; 1,488 candidates across 124 targets; 124 profiles and false-positive audits; and zero validation errors. |
| P-97-02 | Inspect Ujamaa's canonical meso target and governance decision. | A parentless canonical `Ujamaa (African Socialism)` meso node with provisional dedicated-scored status, an eight-source provisional anchor, twelve direct items at 4/4/4, twelve quarantined candidates at 4/4/4, a seventeen-dimension existing-facet profile, six neighbor discriminants, a false-positive audit, and explicit `promote-to-canonical` governance dated 2026-08-29. |
| P-97-03 | Run isolated anchor reachability and full fixture diagnostics for Ujamaa. | Ujamaa reaches every layer in the isolated-anchor fixture with no structural failure; production combined reachability is present; full-production overlap remains deterministic geometry evidence only and does not trigger uncalibrated scorer or picker retuning. |
| P-97-04 | Inspect the Ujamaa boundary and schema gap. | Direct items require convergent postcolonial structural, familyhood/social-relation, collective-self-reliance, participatory nation-building, and communal/public-development content; identity, ruralism, nationalism, generic Socialism, communitarianism, public ownership, public services, self-reliance, one policy, one actor, or one outcome alone is insufficient; no dedicated African-Socialism facet is invented. |
| P-97-05 | Run complete-answer share round trip. | The versioned v2 fragment remains within the 40,960-character finite bound and decodes to the complete answer map; the supported share test passes. |
| P-97-06 | Run delivery and browser checks. | TypeScript, focused/full Vitest, build, high-severity audit, coverage, reachability, Compose/Docker, `/healthz`, and Docker-backed Playwright pass; no cognitive, respondent, psychometric, or empirical claim. |

| P-99-01 | Inspect the Labor Zionism source-backed canonical micro target and taxonomy decision. | A `Nationalism → Labor Zionism` canonical micro node with provisional dedicated-scored status, eight source references, a provisional anchor, twelve direct items at 4/4/4, twelve quarantined candidates at 4/4/4, a seventeen-dimension existing-facet profile, six neighbor discriminants, a false-positive audit, coverage metadata, and explicit `promote-to-canonical` governance dated 2026-08-30. |
| P-99-02 | Inspect Labor Zionism's historical and relational boundary. | Direct and research-bank items require convergent national self-determination, worker-socialist transformation, land/labor and settlement mechanisms, institution-building, and transnational variation; Jewish identity, citizenship, labor sympathy, one party or settlement, current conflict position, or one policy is insufficient. |
| P-99-03 | Run Labor Zionism isolated reachability and full fixture diagnostics. | All three layers are structurally reachable through the isolated anchor fixture; any full-production overlap or rank output is retained as deterministic geometry evidence only and does not authorize coefficient, picker, threshold, or anchor retuning. |
| P-99-04 | Run the complete delivery and browser gates. | TypeScript, focused/full Vitest, build, audit, coverage, reachability, Compose/Docker, `/healthz`, share, and Playwright pass from actual current-tree execution; no cognitive, respondent, psychometric, or empirical claim is made. |

## V100 QA scenarios — Islamic Feminism canonical micro promotion

| ID | Scenario | Expected evidence |
|---|---|---|
| P-100-01 | Run research coverage and dataset validation after the Islamic Feminism promotion. | Content version 96; 1,488 prompts at 496 per layer; 123 editorial anchors; 118 production anchors; 124 ontology nodes with 9 macro / 44 total meso / 71 micro placements and 9 macro / 38 canonical meso / 71 canonical micro inventory; 3 registry entries; 6 contextual placements; 1,524 candidates across 127 targets; complete profiles, false-positive audits, and coverage rows; and zero validation errors. |
| P-100-02 | Inspect the Islamic Feminism canonical micro target and governance decision. | A `Feminism → Islamic Feminism` canonical micro node with provisional dedicated-scored status, nine source references, a provisional existing-facet anchor, twelve direct items at 4/4/4, twelve quarantined candidates at 4/4/4, a seventeen-dimension profile, six neighbor discriminants, a false-positive audit, and explicit `promote-to-canonical` governance dated 2026-08-30. |
| P-100-03 | Inspect the Islamic Feminism interpretive and institutional boundary. | Direct and research-bank items require convergent gender justice, critical Islamic interpretation or legal tradition, and institutional, civic, or activist routes; Muslim identity, piety, observance, generic feminism, women's rights, Islamism, Religious Nationalism, one interpreter, legal school, organization, jurisdiction, or policy is insufficient. |
| P-100-04 | Run Islamic Feminism isolated reachability and full fixture diagnostics. | The anchor reaches all three layers in the isolated fixture with no structural failure; full-production ranks remain deterministic geometry evidence only and do not authorize coefficient, picker, threshold, or anchor retuning. |
| P-100-05 | Run the complete delivery and browser gates. | TypeScript, focused/full Vitest, build, high-severity audit, coverage, reachability, share, and Playwright pass from actual current-tree execution; Compose/Docker is recorded separately if run; no cognitive, respondent, psychometric, or empirical claim is made. |

## V103 QA scenarios — registry-boundary source refresh

| ID | Scenario | Expected evidence |
|---|---|---|
| P-103-01 | Run research coverage and dataset validation after the registry-boundary refresh. | Content version 97; 1,500 prompts at 500 per layer; 124 editorial anchors; 119 production anchors; 125 ontology nodes with 9 macro / 44 total meso / 72 micro placements and 9 macro / 38 canonical meso / 72 canonical micro inventory; 2 registry entries; 6 contextual placements; 1,524 candidates across 127 targets; and zero validation errors. |
| P-103-02 | Inspect Civic Republicanism's refreshed registry boundary and governance decision. | An associated-tradition registry entry with registry-only/not-scored status, refreshed Republicanism and Lovett provenance, seven registry source references, twelve effect-free candidates at 4/4/4, a five-dimension qualitative profile, two neighbor discriminants, a false-positive audit, no canonical node or production questions, and explicit `retain-registry-only` governance dated 2026-08-30. |
| P-103-03 | Inspect Conservative New Right's refreshed contextual boundary and governance decision. | A contextual-formation registry entry with registry-only/not-scored status, refreshed New Right provenance including Schilk, twelve effect-free candidates at 4/4/4, a seven-dimension qualitative profile, three neighbor discriminants, a false-positive audit, no canonical node or production questions, and explicit `retain-registry-only` governance dated 2026-08-30. |
| P-103-04 | Confirm production isolation and unchanged sorter semantics. | Civic Republicanism and Conservative New Right remain absent from production question targets and anchors; no ontology node, effect vector, coefficient, threshold, picker rule, layer weight, morphology path, combined-layer semantic, or share semantic changes. |
| P-103-05 | Run the complete delivery and browser gates. | TypeScript, focused/full Vitest, build, high-severity audit, coverage, reachability, share, and Playwright are reported from actual current-tree execution; Compose/Docker is recorded separately if run; no cognitive, respondent, psychometric, or empirical claim is made. |
