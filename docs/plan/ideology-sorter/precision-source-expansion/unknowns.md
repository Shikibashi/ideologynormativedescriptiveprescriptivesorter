...
- The preceding baseline bank had 84 original prompts, 28 per layer, and approximate editorial anchors.
- The active continuation has 204 original prompts, 68 per layer, and eleven provisional dedicated-scored target blocks.
- The user observed several labels at 99% and considers the result too coarse.
- Academic source support is required for the construct and item-development rationale.
- The project must not present the output as a scientific diagnosis or political recommendation.

## Inferred decisions

| Decision | Conservative default | Reversal path |
|---|---|---|
| Item-bank size | 204 total, 68 per layer | Add a further versioned batch without changing the scoring API. |
| Source posture | Original local wording with academic/conceptual provenance | Retire or revise an item after documented wording and construct review. |
| Anchor posture | Keep anchors editorial and add source-role metadata | Replace with a separately reviewed calibration dataset later. |
| Result language | Rank neighbors but show low separation explicitly; avoid false percentage precision | Add a validated uncertainty model only after data collection. |
| Share compatibility | Bump content and policy versions so old links fail closed | Add an explicit migration adapter only if an old-link policy is approved. |
| Promotion review | Preserve a documented decision before production language | Require neighbor-distinctness review, applicable cross-cultural/jurisdictional review or a not-applicable rationale, and later empirical validation before promotion; keep wording, target rationale, source rationale, and unresolved risks attached to each revision. |

## Risks to keep visible

- More items can increase burden without increasing construct validity; the 204-item bank remains provisional, and no cognitive review was run in the current continuation.
- Academic citations can support a construct without supporting the local item wording or anchor vector.
- Party-position datasets are context- and time-dependent and must not silently become respondent labels.
- Close neighbors may be a genuine property of a respondent's answers; the UI should communicate ambiguity rather than force a winner.

## Current v6 status

- The live bank contains 252 prompts, 84 per layer, and 15 canonical scoring anchors out of 20 editorial anchor records.
- Five broad bridge anchors are intentionally `contextual-only`: their source-backed context remains inspectable, but their broad meaning is not admitted to production neighbor scoring.
- Libertarianism, Marxism, Social Anarchism, and Liberal Feminism received source-backed direct blocks. Their prompts and anchor vectors remain provisional editorial content; no cognitive review, respondent evidence, or psychometric validation was run.

## Current v7 status

- The live bank contains 348 prompts, 116 per layer, 28 editorial anchors, and 23 canonical scoring anchors. Eight existing canonical meso branches received source-backed direct blocks: Christian Democracy, Contemporary Neo-Republicanism, Black Feminism, Ecofeminism, Green Anarchism, Anarcha-Feminism, Liberal Nationalism, and Radical Feminism.
- The ontology remains 9 macro, 33 canonical meso, and 60 canonical micro nodes, with five contextual-placement nodes and a separate 12-entry registry. Coverage is 23 `dedicated-scored`, 79 `catalog-only`, five `contextual-only`, and 12 `registry-only` targets.
- The 1,428 candidates remain quarantined, effect-free review records across 119 targets. The new source records support construct boundaries and item-writing rationale; they do not validate the local wording or vectors.
- No cognitive review, respondent evidence, substitute simulation, psychometric calibration, reliability/validity estimate, cross-context study, or population evidence was run. The next promotion gate remains empirical and fail-closed.

## Current v8 status — 2026-08-26

- The live bank contains 408 prompts, 136 per layer, 33 editorial anchors, and 28 canonical scoring anchors. Five source-rich canonical meso branches received direct blocks: Communism, Historical Republicanism, Individualist Anarchism, Neoliberalism, and Socialist / Marxist Feminism.
- Nine canonical meso branches remain catalog-only: Conservative Nationalism, Islamism, Mutualism, National Socialism, Neo-Fascism, Populism, Radical Conservatism, Reactionary Conservatism, and Religious Nationalism. These are explicit holds for host/jurisdictional, contested-label, or high-risk historical boundaries, not ontology demotions.
- The 1,428 candidates remain quarantined, effect-free review records across 119 targets. No cognitive review, respondent evidence, substitute simulation, psychometric calibration, reliability/validity estimate, invariance study, or population evidence was run.

## Current v10 status — 2026-08-26

- The live bank contains 456 prompts, 152 per layer, 37 editorial anchors, and 32 canonical scoring anchors. Radical Conservatism and Reactionary Conservatism received source-backed 4/4/4 direct blocks; five canonical meso holds remain catalog-only.
- Their nearest boundary is restoration of a displaced order versus decisive renewal against a new orthodoxy. Current facets represent this only indirectly through institutionalism, order/tradition, and reformism, so full-production overlap remains a measurement-design diagnostic.
...
- Conservative Nationalism is bounded by inherited national continuity, bounded civic solidarity, sovereignty and self-government, institutional stewardship, and accountable gradual change. The shared facet geometry remains an editorial approximation and the national-conservative label remains contested across contexts.
...
- The complete v15 share fragment measures 33,459 characters and fits under the explicit finite 36,864-character guard. The capacity change preserves answer-only serialization and fail-closed stale/malformed/oversized handling; it does not provide privacy or URL-size assurance.
...
## Current v11 status — 2026-08-26

- The live bank contains 468 prompts, 156 per layer, 38 editorial anchors, and 33 canonical scoring anchors. Islamism received a source-backed 4/4/4 direct block; Conservative Nationalism, National Socialism, Neo-Fascism, and Religious Nationalism remain catalog-only.
...
## Current v9 status — 2026-08-26

- The live bank contains 432 prompts, 144 per layer, 35 editorial anchors, and 30 canonical scoring anchors. Populism and Mutualism received source-backed 4/4/4 direct blocks; the seven remaining canonical meso holds remain catalog-only.
- The live scorer remains policy version 3. A deterministic full-competition fixture shows top-three overlap is materially coarser than isolated-anchor routing (50% layer hit rate, 70% combined hit rate; worst ranks 27 and 23). This is a measurement-design backlog signal, not a basis for an uncalibrated scoring change.
- The structural audit passes validation, target-block closure, and isolated-anchor routing for all 30 production anchors. It intentionally reports, rather than hides, the production top-three overlap.
- The 1,428 candidates remain quarantined and effect-free across 119 targets. No cognitive review, respondent evidence, substitute simulation, psychometric calibration, reliability/validity estimate, invariance study, or population evidence was run.

## Current v16 unknowns — 2026-08-27

- National Socialism is now dedicated-scored only as a provisional historical analytical field: German National Socialism, especially the interwar movement and the 1933–1945 regime. Remaining measurement gaps include historical period and national variation, coded-language and false-positive risk, the boundary with broader Fascism and generic authoritarianism, and later respondent/empirical validation.
- Neo-Fascism remains catalog-only because post-1945 continuity, adaptation, and organizational boundaries are not closed for a single production block. No label is forced as a substitute, and no ontology node is demoted.
- The isolated National Socialism fixture closes all three layers. The full-production diagnostic reports 1/1/1 layer ranks and 1 combined for National Socialism, while aggregate overlap and worst ranks remain design diagnostics rather than respondent evidence or a basis for arbitrary scorer retuning.
- The 1,428 candidates remain effect-free and quarantined across 119 targets. No cognitive review, respondent evidence, substitute simulation, psychometric calibration, reliability/validity estimate, invariance study, empirical validation, or population evidence was run; later promotion gates remain fail-closed.
...
- Marxist Feminism and Socialist Feminism remain distinct catalog branches, Anti-Colonial Nationalism remains an unactivated alternative, and Neo-Fascism remains a high-risk catalog-only hold. The 1,428 candidates remain effect-free and quarantined; no cognitive review, respondent evidence, substitute simulation, psychometric calibration, reliability/validity estimate, invariance study, empirical validation, or population evidence was run; later promotion gates remain fail-closed.
...
## Current v25 unknowns — Trotskyism — 2026-08-27

- The construct is provisional: open issues include Fourth International and later organizational variation, competing interpretations of Permanent Revolution, national transfer, and workers' democracy versus party coordination.
- Source support covers historical scope, uneven development, internationalism, worker democracy, anti-bureaucratic critique, and variation for authoring only. It does not justify inference from permanent revolution alone, generic anti-Stalinism, anti-authoritarianism, globalism, socialism, or opposition to one regime.
- Isolated routing closes all three layers; full-production ranks are 9/2/1 and combined rank 1, while aggregate top-three rates are 38.2979% by layer and 48.9362% combined with worst ranks 44 and 41. These are structural diagnostics only.
- Compact v2 is required for the complete v25 share payload because readable v1 would exceed 40,960 characters; v1 remains decodable and no privacy assurance is implied. Marxism-Leninism remains catalog-only and Neo-Fascism remains high-risk. No cognitive review, respondent study, substitute simulation, psychometric, empirical, reliability/validity, invariance, or population evidence was run.

## Current v26 unknowns — Marxism-Leninism — 2026-08-27

- Marxism-Leninism remains provisional. Open boundaries include variation among Leninist traditions, the relationship between party leadership and class self-emancipation, democratic centralism in practice, state transformation, planned coordination, and doctrine versus historical regime.
...
- Isolated routing closes all three layers; full-production ranks are 10/27/1 and combined rank 1, while aggregate top-three rates are 39.5833% by layer and 50.0000% combined with worst ranks 45 and 41. These are structural diagnostics only.
- The readable v1 full-answer representation remains above the finite share guard, so v2 compact index encoding is active at 6,966 characters while v1 remains decodable and no privacy assurance is implied. The 1,428 candidates remain quarantined; Neo-Fascism remains high-risk. No cognitive review, respondent study, substitute simulation, calibration, reliability/validity, invariance, empirical, or population evidence was run.

## Current v27 unknowns — Autonomist Marxism — 2026-08-27

- The construct remains provisional. Open boundaries include variation across Italian and later autonomist traditions, translation of class composition across contexts, social-reproduction wording, and autonomy versus durable institutional coordination.
- Source support covers autonomy, class composition, social reproduction, organizational differentiation, and movement variation for authoring only. It does not justify inference from horizontal style, workplace democracy, anti-authoritarianism, generic anti-capitalism, or one contemporary movement.
- Isolated routing closes all three layers; full-production ranks are 10/8/2 and combined rank 1, while aggregate top-three rates are 37.4140% by layer and 51.0204% combined with worst ranks 46 and 43. These are structural diagnostics only.
- Compact v2 is required for the complete v27 share payload because readable v1 measures 42,915 characters; v1 remains decodable and no privacy assurance is implied. Anarcho-Pacifism and Materialist / Socialist Ecofeminism remain deferred, Neo-Fascism remains high-risk, and no cognitive, psychometric, empirical, reliability/validity, invariance, or population evidence was run.

## Current v28 unknowns — Anarcho-Pacifism — 2026-08-27

- The source-backed construct remains provisional. Open issues include principled versus pragmatic pacifism, pacifism versus nonviolence, self-defense and contested violence definitions, religious/secular variation, radical/reformist routes, historical/geopolitical variation, and translation across anarchist currents.
- Personal nonviolence, opposition to one war, anti-state language, strategic nonviolence, generic anarchism, or one historical movement must not be treated as sufficient evidence. Sources support boundary writing only, not local effects, anchor validity, or respondent classification.
- Isolated routing closes all three layers; full-production ranks are 12/5/2 and combined rank 1, while aggregate top-three rates are 37.3333% by layer and 52.0000% combined with worst ranks 47 and 44. These are structural diagnostics only.
- Readable v1 exceeds the finite share guard, so v2 is active at 7,222 characters while v1 remains decodable and no privacy assurance is implied. Social Ecology, Austromarxism, and Materialist / Socialist Ecofeminism remain deferred; Neo-Fascism remains high-risk; the 1,428 candidates remain quarantined; and no cognitive or empirical evidence was run.

## Current v29 unknowns — Social Ecology — 2026-08-27

- Social Ecology remains provisional. Open boundaries include Bookchin and contemporary municipalist variation, ecological value and future-generational wording, scale and federation, coordination, state capacity, ownership, anthropocentric versus ecocentric reasoning, and historical feasibility.
- The sources support terminology and item-authoring boundaries, not local validity. Environmental concern, localism, municipal policy, decentralization, anti-authoritarianism, Deep Ecology, Green Anarchism, Ecosocialism, Rojava, or Bookchin identification alone is insufficient evidence; local effects, vectors, respondent comprehension, and classification remain unvalidated.
- Isolated routing closes all three layers; full-production ranks are 3/6/4 and combined rank 2, while aggregate rates are 36.6013% by layer and 52.9412% combined with worst ranks 48 and 45. These are structural diagnostics only.
- Compact v2 is active at 7,350 characters because readable v1 measures 44,451; v1 remains decodable and no privacy assurance is implied. Womanism is next in the comparison queue, while the remaining catalog-only and high-risk holds remain quarantined. No cognitive review, respondent study, substitute simulation, psychometric, empirical, reliability/validity, invariance, or population evidence was run.
...
## Current v32 unknowns — Anarcho-Communism / Collectivist Anarchism — 2026-08-27

- Anarcho-Communism remains a provisional and historically varied family boundary rather than a universal standalone school. Open issues include the relation between Bakunin-era collectivist terminology and later communist-anarchist formulations, communal scale, free association, federation, self-defense, and revolutionary versus reformist routes.
- The SEP, Cambridge, Kinna, Bray, and Ostrom sources support anti-hierarchical organization, common ownership, need-oriented provision, free association, historical variation, institutional context, and adjacent boundaries for authoring only. They do not justify inference from anarchism, anti-government sentiment, equality, communal cooperation, common ownership, public ownership, Anarcho-Syndicalism, or Collectivist Anarchism alone; local wording, effects, vectors, respondent comprehension, and classification remain unvalidated.
- Isolated routing closes all three layers; full-production ranks are 11/3/1 and combined rank 1, while aggregate top-three rates are 35.8025% by layer and 51.8519% combined with worst ranks 51 and 47. The full-competition descriptive missing-layer field is a competition diagnostic only and is not grounds for uncalibrated scorer retuning.
...
- Compact v2 is active at 7,862 characters; v1 remains decodable and no privacy assurance is implied. Materialist / Socialist Ecofeminism remains terminology-confounded, Neo-Fascism remains high-risk, the 1,428 candidates remain quarantined, and no cognitive, respondent, simulation, psychometric, empirical, reliability/validity, invariance, or population evidence was run.

## Current v34 unknowns — Anarchism macro family — 2026-08-27

- The family anchor remains provisional and intentionally broad. Open issues include variation among individualist, social, mutualist, communist, feminist, ecological, religious, and historical currents; authority versus coordination; market and non-market organization; institutional scale; violence, reform, and revolutionary strategy; and cross-context translation.
- SEP, Oxford Ward, Cambridge History of Socialism, and Ostrom support terminology, historical variation, federalism, institutional context, and false-positive controls for authoring only. They do not justify inference from anti-government sentiment, localism, personal independence, Libertarianism, Social Anarchism, or any single branch; local wording, effects, vectors, respondent comprehension, and classification remain unvalidated.
- Isolated routing closes all three layers; full-production ranks are 45/45/45 and combined rank 45, while aggregate top-three rates are 32.7381% by layer and 48.2143% combined with worst ranks 53 and 47. These are design diagnostics only and are not grounds for uncalibrated scorer retuning.
...
- The Liberalism family anchor remains provisional and intentionally plural. Open issues include liberty concept variation, rights/property boundaries, markets and welfare, constitutionalism, state capacity, universalism and particularism, international reach, and boundaries with Republicanism, Conservatism, Social Liberalism, Libertarianism, and Neoliberalism.
...
## v39 precision unknowns — Nationalism macro family

- The Nationalism family anchor remains provisional and intentionally plural. Open issues include civic and ethnocultural membership, self-determination versus sovereignty, bounded solidarity, partiality, continuity, anti-colonial and internationalist variation, and boundaries with patriotism, Republicanism, Fascism, Liberal Nationalism, and Ethnocultural Nationalism.
- The current SEP, Oxford, Cambridge, and Anderson sources support terminology, variation, provenance, and false-positive controls for authoring only. They do not justify inference from patriotism, cultural pride, ancestry, ordinary citizenship, one membership rule, one territorial programme, local vectors, respondent comprehension, or classification.
- Isolated routing closes all three layers; full-production ranks are 28/32/14 and combined rank 19, while aggregate top-three rates are 31.6940% by layer and 45.9016% combined with worst ranks 57 and 48. These are design diagnostics only and are not grounds for uncalibrated scorer retuning.
- Compact v2 is active at 8,630 characters; v1 remains decodable and no privacy assurance is implied. The 1,428 candidates remain quarantined, Republicanism is next, Fascism remains high-risk, and no cognitive, respondent, simulation, psychometric, empirical, reliability/validity, invariance, or population evidence was run.

## v40 precision unknowns — Republicanism macro family

- The Republicanism family anchor remains provisional and intentionally spans two related senses. Open issues include historical civic virtue, contemporary non-domination, participation versus institutional design, private power, common goods, sovereignty, cross-border application, and boundaries with Liberalism, Conservatism, Nationalism, patriotism, and the contemporary Republican Party.
- The current SEP, Oxford, civic-republicanism, and democratic-accountability sources support terminology, variation, provenance, and false-positive controls for authoring only. They do not justify inference from patriotism, generic anti-corruption, majoritarianism, constitutionalism alone, one party, one historical republic, local vectors, respondent comprehension, or classification.
- Isolated routing closes all three layers; full-production ranks are 7/1/49 and combined rank 4, while aggregate top-three rates are 29.5699% by layer and 46.7742% combined with worst ranks 58 and 50. These are design diagnostics only and are not grounds for uncalibrated scorer retuning.
- Compact v2 is active at 8,758 characters; v1 remains decodable and no privacy assurance is implied. The 1,428 candidates remain quarantined, Fascism remains high-risk, Feminism requires plural-family boundary work, and no cognitive, respondent, simulation, psychometric, empirical, reliability/validity, invariance, or population evidence was run.

## v41 precision unknowns — Feminism macro family

- The Feminism family anchor remains provisional and intentionally plural. Open issues include the boundaries among liberal, radical, socialist/Marxist/materialist, Black, intersectional, ecological, queer, transnational, decolonial, Indigenous, religious, secular, and democratic traditions; structural versus cultural power; identity versus institution; and formal equality versus substantive transformation.
- The current SEP and Oxford Feminism sources support terminology, variation, provenance, and false-positive controls for authoring only. They do not justify inference from identity, formal equality, care preference, one account of patriarchy, one policy, one branch, local vectors, respondent comprehension, or classification.
- Isolated routing closes all three layers; full-production ranks are 1/2/46 and combined rank 1, while aggregate top-three rates are 30.6878% by layer and 46.0317% combined with worst ranks 59 and 50. These are design diagnostics only and are not grounds for uncalibrated scorer retuning.
- Compact v2 is active at 8,886 characters; v1 remains decodable and no privacy assurance is implied. The 1,428 candidates remain quarantined, 39 ontology targets remain catalog-only, Fascism remains high-risk, and no cognitive, respondent, simulation, psychometric, empirical, reliability/validity, invariance, or population evidence was run.
## v38 unknowns — Socialism macro family

- [ ] Test whether the broad block separates Socialism from Social Democracy, Democratic Socialism, Marxism, Communism, socialist-feminist, and anarchist-socialist profiles in later respondent data.
- [ ] Review interpretation of market coordination, ownership, worker/community control, collective provision, and international solidarity across jurisdictions and traditions.
- [ ] Do not retune the scorer from the deterministic full-production ranks or combined overlap; those fields are design diagnostics only.
- [ ] No evidence yet supports a validated respondent classifier or population-level generalization.

## v42 precision unknowns — Anarcho-Syndicalism micro branch

- The Anarcho-Syndicalism anchor remains provisional and historically/transnationally varied. Open issues include union form, direct action's contested meaning, reformist versus revolutionary strategy, violence and nonviolence, the relation between anarchist principle and syndicalist practice, and boundaries with Social Anarchism, Libertarian Socialism, Guild Socialism, Anarcho-Communism, Collectivist Anarchism, and National-Syndicalism.
- The Oxford and Cambridge sources support terminology, variation, provenance, and false-positive controls for authoring only. They do not justify inference from union membership, labor solidarity, anti-state sentiment, worker consultation, one strike preference, local vectors, respondent comprehension, or classification.
- Isolated routing closes all three layers; full-production ranks are 15/8/1 and combined rank 1, while aggregate top-three rates are 31.25% by layer and 46.875% combined with worst ranks 60 and 51. These are design diagnostics only and are not grounds for uncalibrated scorer retuning.
...
## v48 precision unknowns — Cultural / Spiritual Ecofeminism micro branch

- The Cultural / Spiritual Ecofeminism anchor remains provisional and internally varied. Open issues include religious and secular routes, symbolic and material mechanisms, relational selfhood, care, ecological integrity, cultural difference, intersectional and decolonial critique, appropriation, and the relation between spiritual narratives and public institutions.
- The branch must remain distinct from private spirituality, gender identity, environmental concern, woman–nature essentialism, one religion or goddess tradition, cultural nostalgia, generic Ecofeminism, Cultural Feminism, Materialist / Socialist Ecofeminism, Deep Ecology, anti-technology sentiment, and one author's or community's programme.
- The fresh sources support terminology, plural variation, provenance, and false-positive controls for authoring only. They do not justify inference from spirituality, identity, generic environmentalism, relational language, respondent comprehension, local vectors, or classification.
- Isolated routing closes all three layers; full-production ranks are 13/10/8 and combined rank 6, while aggregate top-three rates are 29.5238% by layer and 45.7143% combined with worst ranks 66 and 57. These are deterministic design diagnostics only and are not grounds for uncalibrated scorer or picker retuning.
...
## v49 precision unknowns — Materialist / Socialist Ecofeminism micro branch

- The Materialist / Socialist Ecofeminism anchor remains provisional and internally varied. Open issues include the relation among capitalist and patriarchal political economy, paid and unpaid labor, social reproduction, resource control, ecological degradation, social reproduction as a public or collective good, and reform versus transformative routes.
- The branch must remain distinct from Cultural / Spiritual Ecofeminism, Materialist Feminism without an ecological connection, generic Socialism or Eco-socialism, green policy, feminism, welfare support, public ownership, social-reproduction language, one country, one theorist, and one state, municipal, cooperative, or autonomous model.
- The fresh sources support terminology, plural and situated variation, provenance, and false-positive controls for authoring only. They do not justify inference from environmental concern, feminism, socialism, care language, public provision, respondent comprehension, local vectors, or classification.
- Isolated routing closes all three layers and the combined calculation; full-production ranks are 2/1/2 and combined rank 1, while aggregate top-three rates are 27.2300% by layer and 45.0704% combined with worst ranks 67 and 59. These are deterministic design diagnostics only and are not grounds for uncalibrated scorer or picker retuning.
...
## v51 precision unknowns — Egoist Anarchism micro branch
...
- Isolated routing closes all three layers and the combined calculation; the full-production fixture ranks the branch 27/6/1 and combined rank 1, while aggregate top-three rates are 26.9406% by layer and 46.5753% combined with worst ranks 69 and 61. These deterministic diagnostics record overlap with Individualist Anarchism, Anarcho-Capitalism, Collectivist Anarchism, Libertarianism, and broad Anarchism; they are not grounds for uncalibrated scorer or picker retuning.
...
- The production boundary requires convergent evidence that gendered or cultural norms shape power, that care/relational/embodied practices can carry political value without naturalizing women, and that feminist transformation changes cultural or institutional valuation while remaining open to contestation. Gender identity, care preference/work, feminist identity, one anti-essentialist statement, generic feminism, one community, one author, or one policy is insufficient.
...
## v53 precision unknowns — Cultural Nationalism micro branch

- The Cultural Nationalism anchor remains a provisional editorial construct in a contested field. Open issues include the relation among cultural and political/civic nationalism, national-community formation, language and schooling, memory and symbols, arts and associations, state and non-state actors, historical and postcolonial variation, and the boundary between cultural continuity and ancestry-based membership.
- The production boundary must require convergent national translation, a cultural nation-formation mechanism, and a collective or public project. It must not infer the branch from cultural pride, language use, ancestry, patriotism, citizenship, civic institutions alone, religious identity, one heritage policy, fixed cultural essence, generic Nationalism, or one historical case. Civic and cultural nationalism may be entangled; Ethnocultural Nationalism's ancestry or inherited-membership rule remains distinct.
- The fresh Oxford, Politics Groups and Identities, Paedagogica Historica, and Croatian Journal of Education sources support terminology, historical/institutional variation, provenance, and false-positive controls for authoring only. They do not justify respondent comprehension, local vector validity, cross-context measurement invariance, or empirical classification.
- Isolated routing closes all three layers at 4/4/4; full-production ranks are 16/38/17 and combined rank 19, while aggregate top-three rates are 25.7778% by layer and 45.3333% combined with worst ranks 71 and 63. The full-competition missing-layer fields are overlap diagnostics because the target is not among the combined neighbors; they are not direct-coverage failures or grounds for uncalibrated scorer or picker retuning.
...
## v54 precision unknowns — Ethnocultural Nationalism micro branch
...
## v55 precision unknowns — Lesbian Feminism micro branch

- The Lesbian Feminism anchor is provisional inside a contested feminist field; unresolved dimensions include compulsory heterosexuality, gendered sexuality institutions, lesbian autonomy, self-definition, community formation, separatism, coalition, trans inclusion, race, class, disability, religion, and historical change.
- The production boundary requires the joint structural sexuality critique, feminist/lesbian autonomy or self-definition, and collective/institutional implication. Identity, orientation, relationship status, feminist identity, sexuality-rights support, anti-men sentiment, generic feminism, one separatist formation, one author, or one policy cannot activate the branch alone.
- The fresh Signs, Wiley, Oxford, and California Scholarship Online sources support authoring and false-positive controls only; they do not establish respondent comprehension, local vector validity, cross-context invariance, or empirical classification.
- Isolated routing is complete at 4/4/4; full-production ranks are 3/16/10 and combined rank 4, with aggregate top-three rates of 26.8398% and 44.1558% and worst ranks 73 and 65. These are overlap diagnostics only and do not justify scorer or picker retuning.
- Compact v2 is active at 10,678 characters; v1 remains decodable. The 1,428 candidates remain quarantined, 25 canonical ontology targets remain catalog-only, and no cognitive, respondent, simulation, psychometric, empirical, reliability/validity, invariance, or population evidence was run.

## v56 precision unknowns — One-Nation Conservatism micro branch

- The One-Nation Conservatism anchor remains provisional in a historically changing field; unresolved issues include how national translation, cross-class cohesion, inherited institutions, social stewardship, markets, welfare, state capacity, constitutional democracy, sovereignty, immigration, social liberalism, and cosmopolitanism combine across periods and contexts.
...
- The EHR/OUP, Contemporary British History, Policy Press, and Political Quarterly sources support authoring and false-positive controls only; they do not establish respondent comprehension, local vector validity, cross-context invariance, or empirical classification.
...
## v58 precision unknowns — Khomeinism micro branch

- The Khomeinism anchor is provisional inside an internally contested Iranian Shi'i Islamist field; unresolved issues include the scope of jurist guardianship, modern sovereignty, clerical/state relations, independence, oppressed-centered mobilization, constitutional participation, national/transnational scope, pre/post-revolutionary practice, and disagreement within Shi'i thought.
...
- [ ] The distinctions from generic Salafism, Islamism, Revolutionary Islamism, Qutbism, Khomeinism, Wasatiyya, religious conservatism, generic sharia support, anti-Western sentiment, authoritarianism, and anti-state anger require continued source comparison rather than deterministic rank-based confidence.
- [ ] The high-risk branch must remain non-operational and must not be used to infer Muslim identity, private faith, current actors, membership, recruitment, tactics, targets, intent, or capability.
...
- [ ] Distinguish additional Sunni, Shi'a, national, transnational, constitutional, democratic, authoritarian, movement-led, and state-mediated cases before treating the cross-case branch as settled.
- [ ] Test false positives from Muslim identity, private faith, religious conservatism, anti-imperialism, anti-elite anger, broad Islamism, and current policy views.
- [ ] Maintain a strict non-operational boundary from Salafi-Jihadism and defer any high-risk expansion until source and expert safeguards are stronger.
- [ ] Cognitive/respondent evidence, empirical reliability/validity, invariance, and population evidence remain required before any wording, effects, anchor vector, or label can be treated as validated measurement; explicitly not run here.
...
## V74 status — Legionary Fascism micro branch

- [x] Existing canonical `Fascism → Legionary Fascism` was retained and activated for provisional dedicated scoring with a historically bounded Romanian/interwar boundary.
- [x] Four fresh academic sources, twelve direct prompts at 4/4/4, one provisional anchor, eight direct source references, two neighbor discriminants, a false-positive audit, a 16-dimension profile, and coverage metadata were added.
- [x] Structural checks pass: 1,224 prompts, 408 per layer, 101 editorial anchors, 96 production anchors, 1,428 quarantined candidates, 119 targets, zero coverage/reachability errors, and Legionary Fascism isolated-reachable in every layer.
- [ ] Full-competition ranks 1/1/2 and 1 combined, aggregate rates 25.6944% and 41.6667%, and worst ranks 91 and 83 are deterministic geometry diagnostics only; no scorer or picker retuning is justified by them.
- [ ] Six canonical ontology targets remain catalog-only: Fascism, Neo-Nazism, Revolutionary Islamism, Salafi-Jihadism, Third Positionism, and White Nationalism.
- [ ] Cognitive/respondent evidence, empirical reliability/validity, invariance, and population evidence remain required and were not run.
...
- [ ] French/Maurrasian, Egyptian, Ukrainian, Georgian, fascist-adjacent, liberationist, monarchist, religious, corporative, democratic, authoritarian, regional, minority, and period applications differ; the local block does not resolve those disputes.
...
## V82 open questions — National-Syndicalism historical microtype

- [ ] The boundary among National-Syndicalism, wider Fascism, Anarcho-Syndicalism, Falangism, Third Positionism, Integral Nationalism, corporatism, and generic nationalism remains historically and internally contested across French, Italian, Portuguese, Spanish, and related cases.
- [ ] Occupational organization, nationally framed solidarity, corporative mediation, transformed public authority, movement/regime translation, democratic and anti-pluralist routes, and economic coordination require continued comparative source review; the local microtype does not settle those disputes.
- [ ] National-Syndicalism is isolated-reachable in all three layers and combined, while full-competition ranks 9/2/1 by layer and 1 combined; aggregate rates and worst ranks 98/91 are deterministic geometry diagnostics only, not respondent evidence or grounds for uncalibrated retuning.
- [ ] Five contextual anchors and 10 registry-only targets remain outside production scoring; cognitive/respondent evidence, empirical reliability/validity, invariance, and population evidence remain required before any wording, effects, anchor vector, or label can be treated as validated measurement.
...
- [ ] Organization, region, empire, race, Irish/Northern Irish context, constitutional orientation, social organization, period, and movement/regime translation require continued comparative source review; the local microtype does not settle those disputes.
...
## V84 unresolved questions — French Fascism

- How should later empirical work separate French Fascism from broader Fascism, National-Syndicalism, Integral Nationalism, National Conservatism, and authoritarian conservatism across organizations and periods?
- Which organization, regional, agrarian, veteran, Vichy/collaboration, Catholic, and imperial distinctions are necessary for future instruments without turning the historical field into a single national stereotype?
- How should the contested neo-socialist conversion boundary be represented when sources and cases disagree?
- The current isolated routing is technical evidence only; respondent comprehension, reliability, validity, invariance, and population transport remain untested and outside this no-cognitive-review tranche.

## V86 unresolved questions — Japanese Fascism

- How should Japanese Fascism be separated from wider Fascism, Italian Fascism, National Socialism, National-Syndicalism, Integral Nationalism, National Conservatism, and generic militarism or authoritarianism when the comparative label is itself disputed?
- Which intellectual, military, bureaucratic, technocratic, associational, New Order, wartime, domestic, imperial, and Manchurian distinctions are necessary for future research without treating Japan or Japanese identity as a single fascist case?
- How should the 1940 New Order Movement, party-government breakdown, wartime mobilization, and Manchukuo be represented without overclaiming a uniform party-seizure or regime pathway?
- The deterministic audit is technical evidence only; respondent comprehension, reliability, validity, invariance, empirical classification, and population transport remain untested and outside this no-cognitive-review tranche.

## V85 unresolved questions — Italian Fascism

- How should Italian Fascism be separated from the wider Fascism family, National-Syndicalism, Falangism, Legionary Fascism, National Conservatism, generic authoritarianism, nationalism, corporatism, Italian identity, and one-leader or order preferences?
- Which movement, party, coalition, dictatorship, local, industrial, agrarian, Catholic, secular, wartime, racial, imperial, and period distinctions must remain explicit rather than being collapsed into a single Italian case?
...
## V89 unresolved questions — Bioregionalism ecological microtype
...
## V103 open questions — Civic Republicanism and Conservative New Right registry boundaries

- How should the sorter preserve the difference between Civic Republicanism as a historical civic-virtue/participation label and contemporary civic or neo-republican frameworks organized around non-domination, rule-bound public power, and popular control without creating duplicate canonical ancestry?
- Which combinations of civic participation, equal standing, contestable institutions, and protection from domination are durable enough for future qualitative metadata, and which remain tied to a specific republican theory, historical period, or institutional design?
- How should New Right metadata distinguish Anglo-American or British conservative/neoliberal uses from the European radical-conservative and metapolitical field, including narrative work versus political actors, without creating a second label that merely duplicates existing canonical nodes?
- The 24 candidates remain quarantined and effect-free; no production questions, anchors, current-party labels, or respondent-facing classification are authorized by V103. Terminology and qualitative profiles are not cognitive, psychometric, empirical, or population evidence.
- Registry-only retention, isolated anchor exclusion, and full-competition geometry diagnostics remain unchanged. Cognitive/respondent comprehension, expert adjudication, reliability/validity, invariance/DIF, empirical classification, population/consequence review, and held-out respondent morphology remain untested by explicit constraint.
