...
## v61 specification — Marxist Feminism micro branch

V61 adds provisional direct measurement to the existing canonical `Socialist / Marxist Feminism → Marxist Feminism` micro node: four descriptive, four normative, and four prescriptive prompts plus one provisional anchor. The construct covers linked class and gendered power, capitalist production, social reproduction, labor and care, material dependence, and transformative emancipation; generic Feminism, Marxism alone, welfare or public ownership alone, unpaid-care concern alone, or one institutional route is insufficient.

The contract is 1,068 prompts (356 per layer), 88 editorial anchors, 83 scoring anchors, 19 canonical catalog-only targets, 12 registry targets, and 1,428 effect-free candidates across 119 targets. Governance retains the node as canonical with `retain-canonical` and `resultingScoringStatus: scored-provisional`; live measurement is separately `dedicated-scored`. Delivery checks remain evidence-gated; respondent and empirical evidence remain open.
...
## v64 specification — Neoconservatism micro branch

V64 adds provisional direct measurement to the existing canonical `Conservatism → Neoconservatism` micro node: four descriptive, four normative, and four prescriptive prompts plus one provisional anchor. The construct covers historically situated critique of relativism and pluralist fragmentation, republican-democratic common purpose, moral and civic order, active and accountable public authority, and contested national-interest/international-engagement routes; generic Conservatism, Neoliberalism, National Conservatism, Paleoconservatism, anti-communism, military hawkishness, market support alone, current-party affiliation, one thinker, one country, one war, or one policy is insufficient.

The contract is 1,104 prompts (368 per layer), 91 editorial anchors, 86 scoring anchors, 16 canonical catalog-only targets, 12 registry targets, and 1,428 effect-free candidates across 119 targets. Governance retains the node as canonical with `retain-canonical` and `resultingScoringStatus: scored-provisional`; live measurement is separately `dedicated-scored`. Delivery checks pass; respondent and empirical evidence remain open and were not run.
## v65 specification — Paleoconservatism micro branch

V65 adds provisional direct measurement to the existing canonical Conservatism → Paleoconservatism micro node: four descriptive, four normative, and four prescriptive prompts plus one provisional anchor. The construct covers historically situated post-war New Right formation, national particularity or sovereignty, inherited culture and local authority, restraint toward centralized or globalizing projects, and critique of universalizing or market-globalist arrangements; generic Conservatism, National Conservatism, Neoconservatism, Right-Wing Populism, the alt-right, White Nationalism, immigration concern alone, anti-globalization alone, protectionism alone, religious identity, one thinker, one party, one policy, or one issue is insufficient.

The contract is 1,116 prompts (372 per layer), 92 editorial anchors, 87 scoring anchors, 15 canonical catalog-only targets, 12 registry targets, and 1,428 effect-free candidates across 119 targets. Governance retains the node as canonical with retain-canonical and resultingScoringStatus scored-provisional; live measurement is separately dedicated-scored. Delivery checks pass; respondent and empirical evidence remain open and were not run.

## V66 specification — Wasatiyya micro branch

V66 adds provisional direct measurement to the existing canonical Islamism → Wasatiyya micro node: four descriptive, four normative, and four prescriptive prompts plus one provisional anchor. The construct covers a contested middle-way or centrist Islamist public vocabulary for negotiating modernity, participation, citizenship, coexistence, and public moral order, with theological, reformist, movement, national, transnational, egalitarian-citizenship, hierarchical-citizenship, and state-sponsored variation; Muslim identity, private piety, generic Islamism, moderation as a scalar score, liberal democracy, electoral participation, state counter-extremism branding, one scholar, one organization, one fatwa, one leader, or one policy is insufficient.

The contract is 1,128 prompts (376 per layer), 93 editorial anchors, 88 scoring anchors, 14 canonical catalog-only targets, 12 registry targets, and 1,428 effect-free candidates across 119 targets. Governance retains the node as canonical with retain-canonical and resultingScoringStatus scored-provisional; live measurement is separately dedicated-scored. Delivery checks pass; respondent and empirical evidence remain open and were not run.

## V67 precision specification — Right-Wing Populism micro branch

V67 adds provisional direct measurement to the existing canonical Populism → Right-Wing Populism micro node: four descriptive, four normative, and four prescriptive prompts plus one provisional anchor. The construct covers a people-versus-elite articulation joined to a right-wing national or culturally conservative host, with national, cultural, ethnocultural, nativist, conservative, authoritarian, economic, institutional, democratic, anti-pluralist, party, movement, leadership, country, temporal, and transnational variation; generic anti-elite dissatisfaction, national pride, immigration concern, nativism or authoritarianism alone, Nationalism, Conservatism, National Conservatism, Ethnocultural Nationalism, Left-Wing Populism, and one policy or issue are insufficient.

The contract is 1,140 prompts (380 per layer), 94 editorial anchors, 89 scoring anchors, 13 canonical catalog-only targets, 12 registry targets, and 1,428 effect-free candidates across 119 targets. Governance retains the node as canonical with retain-canonical and resultingScoringStatus scored-provisional; live measurement is separately dedicated-scored. Delivery checks pass; respondent and empirical evidence remain open and were not run.
## V68 precision specification — Hindutva micro branch

V68 adds provisional direct measurement to the existing canonical `Religious Nationalism → Hindutva (Hindu Nationalism)` micro node: four descriptive, four normative, and four prescriptive prompts plus one provisional anchor. The construct covers a historically specific and internally contested Hindu-national political formulation linking Hindu civilizational or cultural nationhood to public authority, political membership, and institutional transformation, with religiously thick and culturally secularized, caste, pluralist, majoritarian, historical, contemporary, movement, party, state, educational, legal, symbolic, and diaspora variation. Hindu faith, piety, cultural identity, Indian patriotism, generic Nationalism or Religious Nationalism, current actors or policies, anti-minority sentiment alone, and operational hostility are insufficient.

The contract is 1,152 prompts (384 per layer), 95 editorial anchors, 90 scoring anchors, 12 canonical catalog-only targets, 12 registry targets, and 1,428 effect-free candidates across 119 targets. Governance retains the node as canonical with `retain-canonical` and `resultingScoringStatus: scored-provisional`; live measurement is separately `dedicated-scored`. Delivery checks pass; respondent and empirical evidence remain open and were not run.


## V69 — Religious Zionism micro branch

V69 adds provisional direct measurement to the existing canonical `Religious Nationalism → Religious Zionism` micro node: four descriptive, four normative, and four prescriptive prompts plus one provisional anchor. The construct covers a historically situated and internally plural Jewish religious-national current connecting religious interpretation, Jewish collective self-determination, and public/state institutions, with variation over theology, statehood, territory, democracy, constitutionalism, organization, and diaspora. Jewish identity, private faith, broad Zionism, Israeli citizenship or patriotism, one theological claim, one party or leader, current government or territorial/war policy, anti-Arab or anti-Palestinian sentiment alone, and one territorial preference are insufficient.

The contract is 1,164 prompts (388 per layer), 96 editorial anchors, 91 scoring anchors, 11 canonical catalog-only targets, 12 registry targets, and 1,428 effect-free candidates across 119 targets. Governance retains the node as canonical with `retain-canonical` and `resultingScoringStatus: scored-provisional`; live measurement is separately `dedicated-scored`. Delivery checks pass; respondent and empirical evidence remain open and were not run.

## V70 — Neo-Fascism meso branch

V70 adds provisional direct measurement to the existing canonical Fascism → Neo-Fascism meso node: four descriptive, four normative, and four prescriptive prompts plus one provisional anchor. The construct covers a historically situated post-1945 field of fascist continuities, adaptations, and revivals, with variation over country, generation, organization, democracy, corporatism, state power, anti-communism, sovereignty, and transnational form. Generic nationalism, authoritarianism, anti-communism, immigration concern, racial prejudice, violence, nostalgia, one symbol, one party, one leader, one country, one current policy, and operational tactics are insufficient.

The contract is 1,176 prompts (392 per layer), 97 editorial anchors, 92 scoring anchors, 10 canonical catalog-only targets, 12 registry targets, and 1,428 effect-free candidates across 119 targets. Governance retains the node as canonical with retain-canonical and resultingScoringStatus scored-provisional; live measurement is separately dedicated-scored. Delivery checks pass; respondent and empirical evidence remain open and were not run.

## V71 — Falangism micro branch

V71 adds provisional direct measurement to the existing canonical `Fascism → Falangism` micro node: four descriptive, four normative, and four prescriptive prompts plus one provisional anchor. The construct covers a historically situated Spanish fascist and national-syndicalist current associated with the Falange Española and FE de las JONS and its interwar-to-Franco transformations, including national rebirth, disciplined movement authority, corporative/institutional translation, Catholicism as a national attribute, and contested relations among movement, state, democracy, membership, sovereignty, and economic coordination. Spanish identity, patriotism, Catholic faith, generic Fascism or National-Syndicalism, anti-party sentiment, corporatism or state capacity alone, one leader, one symbol, one party, one policy, current politics, and operational tactics are insufficient.

The contract is 1,188 prompts (396 per layer), 98 editorial anchors, 93 scoring anchors, 9 canonical catalog-only targets, 12 registry targets, and 1,428 effect-free candidates across 119 targets. Governance retains the node as canonical with `retain-canonical` and `resultingScoringStatus: scored-provisional`; live measurement is separately `dedicated-scored`. Delivery checks pass; respondent and empirical evidence remain open and were not run.

## V72 — Brazilian Integralism micro branch

V72 adds provisional direct measurement to the existing canonical `Fascism → Brazilian Integralism` micro node: four descriptive, four normative, and four prescriptive prompts plus one provisional anchor. The construct covers a historically situated Brazilian integralist current associated with the Ação Integralista Brasileira and later Plínio Salgado reinterpretations, including Brazilian translation of transnational fascist repertoires, organic national unity, religious-cultural public purpose, corporative mediation, movement-centered authority, and contested relations among movement, state, democracy, rights, membership, and sovereignty. Brazilian identity, patriotism, Catholic faith, generic nationalism, anti-communism, corporative policy or state capacity alone, Falangism, Integral Nationalism, current actors, current policies, and operational tactics are insufficient.

The contract is 1,200 prompts (400 per layer), 99 editorial anchors, 94 scoring anchors, 8 canonical catalog-only targets, 12 registry targets, and 1,428 effect-free candidates across 119 targets. Governance retains the node as canonical with `retain-canonical` and `resultingScoringStatus: scored-provisional`; live measurement is separately `dedicated-scored`. Delivery checks pass; respondent and empirical evidence remain open and were not run.

## V73 — Integral Nationalism cross-case historical category

V73 adds provisional direct measurement to the existing canonical `Nationalism → Integral Nationalism` micro node: four descriptive, four normative, and four prescriptive prompts plus one provisional anchor. The construct is a contested cross-case historical category associated with Maurrasian national absolutism and applied in scholarship to varied Egyptian, Ukrainian, Georgian, and fascist-synthesis formations. It requires an overriding national principle, anti-fragmentation, and integrated authority while preserving national, religious, monarchist, liberationist, democratic, authoritarian, regional, minority, and period variation. National pride, patriotism, cultural identity, sovereignty preference, generic Nationalism, Fascism as a whole, Brazilian Integralism, one country, one leader, one policy, and operational tactics are insufficient.

The contract is 1,212 prompts (404 per layer), 100 editorial anchors, 95 scoring anchors, 7 canonical catalog-only targets, 12 registry targets, and 1,428 effect-free candidates across 119 targets. Governance retains the node as canonical with `retain-canonical` and `resultingScoringStatus: scored-provisional`; live measurement is separately `dedicated-scored`. Delivery and structural checks are recorded in the verification report; respondent and empirical evidence remain open and were not run.

## V74 — Legionary Fascism micro branch

V74 adds provisional direct measurement to the existing canonical `Fascism → Legionary Fascism` micro node: four descriptive, four normative, and four prescriptive prompts plus one provisional anchor. The construct is a historically bounded Romanian fascist current associated with the Legion of the Archangel Michael / Iron Guard and characterized, as a bundled historical boundary, by political faith or palingenetic renewal, religious-national public doctrine, anti-pluralist organic community, disciplined movement authority, movement/state formation, law, sovereignty, social formation, and interwar period context. Variation over Orthodox institutions, social and gender roles, generations, organization, period, and diaspora/transnational relations is preserved. Romanian identity, Orthodox faith, private piety, generic nationalism, anti-communism, prejudice alone, generic authoritarianism, Fascism as a whole, National Socialism, Neo-Fascism, one leader, one symbol, one party, one event, current politics, and operational tactics are insufficient.

The contract is 1,224 prompts (408 per layer), 101 editorial anchors, 96 scoring anchors, 6 canonical catalog-only targets, 12 registry targets, and 1,428 effect-free candidates across 119 targets. Governance retains the node as canonical with `retain-canonical` and `resultingScoringStatus: scored-provisional`; live measurement is separately `dedicated-scored`. Delivery and structural checks are recorded in the verification report; respondent and empirical evidence remain open and were not run.

## V75 — Fascism macro family

V75 adds provisional direct measurement to the existing canonical Fascism macro node: four descriptive, four normative, and four prescriptive prompts plus one provisional anchor. The construct is a contested family of historically situated revolutionary ultranationalist movements and regimes organized around national rebirth, organic or anti-pluralist community, activist mass politics, movement-centered leadership, and transformed public order. It preserves variation across country, period, doctrine, social base, economic coordination, religious and secular idiom, racialized and non-racialized membership, democracy, violence, war, and institutionalization; National Socialism, Neo-Fascism, Legionary Fascism, Nationalism, Radical Conservatism, authoritarianism, populism, one leader, one symbol, one party, one event, one policy, and operational content remain distinct or insufficient.

The contract is 1,236 prompts (412 per layer), 102 editorial anchors, 97 scoring anchors, 5 canonical catalog-only targets, 12 registry targets, and 1,428 effect-free candidates across 119 targets. Governance retains the node as canonical with `retain-canonical` and `resultingScoringStatus: scored-provisional`; live measurement is separately `dedicated-scored`. Delivery and structural checks are recorded in the verification report; no cognitive, respondent, psychometric, reliability/validity, invariance, empirical, or population evidence was run or implied.

## V76 — White Nationalism high-risk racial-national boundary

V76 adds provisional direct measurement to the existing canonical `Nationalism → White Nationalism` micro node: four descriptive, four normative, and four prescriptive prompts plus one provisional anchor. The construct is a high-risk, historically adaptive racial-national formation that makes a white collective politically constitutive and organizes membership, continuity, power, and institutional preference around that racialized category. The boundary requires convergent racialized political membership, collective continuity or threat diagnosis, racialized power, and public-institution or sovereignty translation. Ancestry or identity alone, demographic or migration concern, ordinary patriotism, ethnocultural nationalism without a white racial membership rule, White Christian Nationalism as a separate synthesis, Neo-Nazism, Fascism, one actor/symbol/slogan/policy, current affiliation, and operational content are insufficient.

The contract is 1,248 prompts (416 per layer), 103 editorial anchors, 98 production anchors, 4 canonical catalog-only targets, 12 registry targets, and 1,428 effect-free candidates across 119 targets. The target has eight direct source references, four neighbor discriminants, a false-positive audit, and an 18-dimension qualitative profile. Governance retains the node as canonical with `retain-canonical` and `resultingScoringStatus: scored-provisional`; live measurement is separately `dedicated-scored`. No ontology node was added or reparented, and no scorer-policy, facet, threshold, combined-layer, contextual-anchor, or candidate-quarantine behavior changed. No cognitive, respondent, psychometric, reliability/validity, invariance, empirical, or population evidence was run or implied.


## V77 — Neo-Nazism postwar continuity and adaptation

V77 adds provisional direct measurement to the existing canonical Fascism → National Socialism → Neo-Nazism micro node: four descriptive, four normative, and four prescriptive prompts plus one provisional anchor. The construct is a high-risk, historically situated postwar successor/revival field that explicitly inherits, revives, or adapts National Socialist political resources and requires racialized or ethnonational membership/power, anti-pluralist restoration, and public-order or institutional translation. It preserves direct continuity, imitation, adaptation, party, network, cultural, esoteric, religious, national, transnational, and period variation. Historical National Socialism as a specific German movement/regime, wider Neo-Fascism, broader White Nationalism, Fascism as a family, Third Positionism, generic nationalism or radical-right rhetoric, authoritarianism, racism or antisemitic prejudice alone, isolated symbols/slogans/affiliations/statements, current actors, and operational content are insufficient.

The contract is 1,260 prompts (420 per layer), 104 editorial anchors, 99 production anchors, 3 canonical catalog-only targets, 12 registry targets, and 1,428 effect-free candidates across 119 targets. The target has eight direct source references, four neighbor discriminants, a false-positive audit, and a 17-dimension qualitative profile. Governance retains the node as canonical with retain-canonical and resultingScoringStatus scored-provisional; live measurement is separately dedicated-scored. No ontology node was added or reparented, and no scorer-policy, facet, threshold, combined-layer, contextual-anchor, or candidate-quarantine behavior changed. No cognitive, respondent, psychometric, reliability/validity, invariance, empirical, or population evidence was run or implied.

## V78 specification record — Revolutionary Islamism

The target contract is the existing canonical Islamism → Revolutionary Islamism micro path with a source-linked canonical node, retain-canonical governance, scored-provisional result, and separately dedicated-scored live measurement. It contains twelve target-tagged prompts at 4/4/4, eight direct source references, one provisional anchor, four neighbor discriminants, a false-positive audit, and a 17-dimension profile. All new effects stay within their descriptive, normative, or prescriptive facet layers.

The V78 dataset contract is 1,272 prompts (424 per layer), 105 editorial anchors, 100 production anchors, 2 canonical catalog-only targets, 12 registry targets, and 1,428 effect-free candidates across 119 targets. The canonical topology, policy version 3 scorer, thresholds, picker, combined-layer semantics, contextual-anchor exclusion, and compact-share compatibility are unchanged. No ontology node was added or reparented.

The boundary requires public Islamic moral-order authority, transformative diagnosis, collective agency, and institutional translation while preserving Sunni/Shi'a, national/transnational, movement/state, constitutional, democratic, authoritarian, reformist, and revolutionary variation. It excludes identity, private faith, generic Islamism, adjacent Islamist labels, current politics, and operational content. No cognitive, respondent, psychometric, reliability/validity, invariance, empirical, or population evidence was run or implied.

## V79 specification record — Third Positionism postwar far-right boundary

The target contract is the existing canonical Fascism → Neo-Fascism → Third Positionism micro path with a source-linked canonical node, retain-canonical governance, scored-provisional result, and separately dedicated-scored live measurement. It contains twelve target-tagged prompts at 4/4/4, eight direct source references, one provisional anchor, four neighbor discriminants, a false-positive audit, and a 17-dimension profile. All new effects stay within their descriptive, normative, or prescriptive facet layers.

The V79 dataset contract is 1,284 prompts (428 per layer), 106 editorial anchors, 101 production anchors, 1 canonical catalog-only target, 12 registry targets, and 1,428 effect-free candidates across 119 targets. The canonical topology, policy version 3 scorer, thresholds, picker, combined-layer semantics, contextual-anchor exclusion, and compact-share compatibility are unchanged. No ontology node was added or reparented.

The boundary requires a historically situated postwar far-right or neo-fascist national-social synthesis beyond liberal capitalism and centralized communism, with convergent anti-liberal, corporative/occupational, sovereign, institutional, or public-order translation. It preserves national, transnational, intellectual, movement, party, economic, constitutional, democratic, and authoritarian variation. It excludes generic nationalism, anti-capitalism, anti-communism, mixed economy, corporatism alone, Peronist or non-aligned “Third Position,” generic third-way language, current actors, recruitment, tactics, violence, and operational content. No cognitive, respondent, psychometric, reliability/validity, invariance, empirical, or population evidence was run or implied.

## V80 specification record — Salafi-Jihadism high-risk doctrinal boundary

The target contract is the existing canonical Islamism → Salafi-Jihadism micro path with a source-linked canonical node, retain-canonical governance, scored-provisional result, and separately dedicated-scored live measurement. It contains twelve target-tagged prompts at 4/4/4, eight direct source references, one provisional anchor, four neighbor discriminants, a false-positive audit, and a 17-dimension profile. All new effects stay within their descriptive, normative, and prescriptive facet layers and avoid operational content.

The V80 dataset contract is 1,296 prompts (432 per layer), 107 editorial anchors, 102 production anchors, no canonical catalog-only target, 12 registry targets, and 1,428 effect-free candidates across 119 targets. The canonical topology, policy version 3 scorer, thresholds, picker, combined-layer semantics, contextual-anchor exclusion, and compact-share compatibility are unchanged. No ontology node was added or reparented.

The boundary requires Salafi scriptural/early-generations authority and purification, divine sovereignty or theonomy, an anti-pluralist political-order boundary, a wider Muslim-community or transnational horizon, and a jihadist-revolutionary transformation claim. It preserves quietist/political/jihadi, national, regional, transnational, intellectual, movement, organizational, and period variation. It excludes Muslim identity, private faith, generic Salafism, religious conservatism, generic sharia support, anti-Western or anti-imperial sentiment, authoritarianism, anti-state anger, adjacent Islamist formations without the distinct bundle, current actors, membership, recruitment, tactics, targets, and operational content. No cognitive, respondent, psychometric, reliability/validity, invariance, empirical, or population evidence was run or implied.
## V81 specification record — Revisionist / Bernsteinian Social Democracy historical microtype

The target contract is the new canonical Socialism → Social Democracy → Revisionist / Bernsteinian Social Democracy micro path with source-linked ontology metadata, promote-to-canonical governance, scored-provisional governance status, and separately dedicated-scored live measurement. It contains twelve target-tagged prompts at 4/4/4, eight direct source references, one provisional anchor, four neighbor discriminants, a false-positive audit, and a 17-dimension profile. All new effects stay within their descriptive, normative, and prescriptive facet layers and the prompts contain no cognitive, operational, membership, or current-actor inference.

The V81 dataset contract is 1,308 prompts (436 per layer), 108 editorial anchors, 103 production anchors, 103 dedicated-scored targets, five contextual-only targets, 11 registry targets, and 1,428 effect-free candidates across 119 targets. The ontology is 108 nodes with canonical inventory 9/33/61 and five contextual placements. The canonical topology, policy version 3 scorer, thresholds, picker, combined-layer semantics, contextual-anchor exclusion, compact-share compatibility, and candidate quarantine are preserved except for the explicitly requested canonical addition.

The boundary requires empirically revisable socialist strategy, democratic means and ends, gradual or constitutional reform, equality and solidarity aims, and institutional or social-provision routes, while preserving historical and internal variation. Generic Social Democracy, Democratic Socialism, Marxism, Market Socialism, Guild Socialism, welfare support alone, public ownership alone, current party membership, present-day identity, one leader, one country, one programme, and generic democracy or reform preference remain insufficient evidence. No cognitive, respondent, psychometric, reliability/validity, invariance, empirical, or population evidence was run or implied.

## V82 specification delta — National-Syndicalism

V82 adds provisional dedicated measurement for the canonical `Fascism → National-Syndicalism` micro path. The production block contains four descriptive, four normative, and four prescriptive prompts plus one provisional anchor. The construct requires a convergent historically bounded and internally varied bundle of occupational organization, nationally framed solidarity, corporative mediation, and transformed public authority. It must preserve variation over national setting, period, movement/regime relationship, democracy, anti-pluralism, and economic coordination.

The block must distinguish wider Fascism, Anarcho-Syndicalism, Falangism, Third Positionism, Integral Nationalism, generic labor solidarity, nationalism, corporatism, mixed economy, current actors, membership, recruitment, tactics, and operational content. It must not infer the target from national pride, union support, anti-state sentiment, corporatism alone, public provision, or one historical case. The source set provides terminology and boundary authority only; no cognitive, respondent, psychometric, reliability/validity, invariance, empirical, or population evidence was run or implied. Existing scoring policy, facets, thresholds, combined-layer semantics, contextual-anchor exclusion, research quarantine, and share semantics remain unchanged.


## V83 specification delta — British Fascism

V83 adds provisional dedicated measurement for the canonical Fascism → British Fascism micro path. The production block contains four descriptive, four normative, and four prescriptive prompts plus one provisional anchor. The construct requires a convergent historically bounded British movement context, national regeneration, anti-pluralist or movement-centered public authority, disciplined social integration, and institutional or imperial translation, while preserving organization, region, empire, race, constitutional, social, and period variation.

The block must distinguish British Fascism from wider Fascism, National Socialism, Neo-Fascism, National-Syndicalism, Falangism, White Nationalism, Integral Nationalism, National Conservatism, British identity, patriotism, conservatism, imperial nostalgia, generic anti-communism, and current actors. It must not infer the target from British identity, national pride, patriotism, conservative preference, empire preference, immigration concern, one organization, one leader, one symbol, one policy, or one historical case alone. The source set provides terminology and boundary authority only; no cognitive, respondent, psychometric, reliability/validity, invariance, empirical, or population evidence was run or implied. Existing scoring policy, facets, thresholds, combined-layer semantics, contextual-anchor exclusion, research quarantine, and share semantics remain unchanged.
## V84 specification delta — French Fascism

French Fascism is a provisional canonical historical micro target under Fascism. It must remain distinct from the wider Fascism family, National Socialism, Neo-Fascism, National-Syndicalism, Integral Nationalism, National Conservatism, conservatism, French identity, patriotism, Catholic identity, rural preference, and current politics. The target context must preserve French organizational, regional, social-base, period, constitutional, Vichy/collaboration, agrarian, Catholic, and imperial variation and must exclude operational content, respondent identity inference, recruitment, tactics, and violence.

The production contract is twelve source-linked prompts at 4/4/4, one provisional anchor, a source-linked 12-dimension profile, four neighbor discriminants, a false-positive audit, and a source-backed promotion decision. Research candidates remain quarantined; the anchor and effects remain editorial and unvalidated.

## V86 specification delta — Japanese Fascism

Japanese Fascism is a provisional canonical historical micro target under Fascism. Its canonical path is `Fascism → Japanese Fascism`; its live measurement state is `dedicated-scored`, while its governance state remains `scored-provisional`. The target must be source-linked to Fletcher, Hofmann, Young, Mimura, Tsuzuki, existing Japanese Fascism context, existing Fascism context, and existing political-ideologies context.

The target context must cover a contested interwar and early-Shōwa field through 1945: intellectual, military, bureaucratic, technocratic, associational, New Order, wartime, and imperial or Manchurian formations. It must preserve scholarly disagreement over applying the label to Japan as a whole and distinguish Japanese Fascism from Fascism as the wider family, Italian Fascism, National Socialism, National-Syndicalism, Integral Nationalism, National Conservatism, generic militarism, authoritarianism, imperialism, Japanese identity, cultural tradition, patriotism, security preference, one institution, current actors, current Japan, and postwar identity.

The production contract is twelve target-tagged questions at descriptive/normative/prescriptive 4/4/4, one provisional anchor, eight direct source references, a 17-dimension profile, four neighbor discriminants, a false-positive audit, and explicit promote-to-canonical governance. Effects must remain within their claim layer. The target is historical and non-operational: no recruitment, tactics, violence, current-actor classification, respondent identity inference, cognitive review, substitute simulation, psychometric validation, or empirical validation is included.

## V85 specification delta — Italian Fascism

Italian Fascism is a provisional canonical historical micro target under Fascism. It must remain distinct from Fascism as the wider family, National Socialism, Neo-Fascism, National-Syndicalism, Falangism, Legionary Fascism, National Conservatism, generic authoritarianism, Italian identity, patriotism, nationalism, corporatism, order preference, one leader, one policy, and current politics. The target context must preserve movement, party, coalition, dictatorship, local, industrial, agrarian, Catholic, secular, wartime, racial, imperial, project-versus-realization, and period variation and must exclude operational content, respondent identity inference, recruitment, tactics, and violence.

The production contract is twelve source-linked prompts at 4/4/4, eight direct source references, one provisional anchor, a source-linked 17-dimension profile, four neighbor discriminants, a false-positive audit, and a source-backed promotion decision. Research candidates remain quarantined; the anchor and effects remain editorial and unvalidated. The version-85 contract is 1,356 prompts (452 per layer), 112 editorial anchors, 107 production anchors, 112 ontology nodes, and 7 registry entries. No cognitive, respondent, psychometric, reliability/validity, invariance, empirical, or population evidence was run or implied.

## V89 specification delta — Bioregionalism ecological microtype

Bioregionalism is a provisional canonical ecological micro target under `Ecologism / Green Ideology`. Its canonical path is `Ecologism / Green Ideology → Bioregionalism`; its live measurement state is `dedicated-scored`, while governance remains `scored-provisional`. The target must remain bounded to a convergent relationship among ecological place or bioregional scale, socio-ecological relations, and accountable governance, and must preserve biophysical, inhabiting, networked, ontological, critical, processual, local, regional, interregional, urban, rural, more-than-human, participatory, justice-oriented, and jurisdictional variation.

The target must remain distinct from generic environmental concern, local identity, watershed or land-use preference, Deep Ecology's intrinsic-value emphasis, Social Ecology's social-hierarchy and municipalist mechanism, Green Politics as a movement umbrella, decentralization alone, current actors, and respondent inference. It is historical, contested, provisional, and non-diagnostic; no naturalized bioregional boundary or exclusionary membership rule may be inferred.

The production contract is twelve source-linked prompts at descriptive/normative/prescriptive 4/4/4, seven direct source references, one provisional anchor, a source-linked seven-dimension profile, three neighbor discriminants, a false-positive audit, and a source-backed promotion decision. Effects must remain within their claim layer. Research candidates remain quarantined, and scorer policy version 3, picker/facet/threshold/distance semantics, combined-layer behavior, contextual-anchor exclusion, and compact-share compatibility remain unchanged. The version-89 contract is 1,404 prompts (468 per layer), 116 editorial anchors, 111 production anchors, 116 ontology nodes, and 3 registry entries. No cognitive, respondent, psychometric, reliability/validity, invariance, empirical, or population evidence was run or implied.

## V87 specification delta — Flemish / Belgian Fascism

Flemish / Belgian Fascism is a provisional canonical historical micro target under Fascism. It must remain a bounded, contested field through 1945 and distinct from the wider Fascism family, French Fascism, Integral Nationalism, National-Syndicalism, Flemish or Belgian identity, language politics, regional autonomy, Catholicism, corporatism, authoritarianism, anti-parliamentary dissatisfaction, collaboration alone, current actors, and current Belgium or Flanders. Target context must preserve Flemish, Francophone, Belgian, regional, organizational, Catholic/secular, corporative, technocratic, occupation, collaboration, and project-versus-realization variation and must exclude operational content and respondent identity inference.

The production contract is twelve source-linked prompts at 4/4/4, nine direct source references, one provisional anchor, a source-linked 17-dimension profile, four neighbor discriminants, a false-positive audit, and a source-backed promotion decision. Research candidates remain quarantined; the anchor and effects remain editorial and unvalidated. The version-87 contract is 1,380 prompts (460 per layer), 114 editorial anchors, 109 production anchors, 114 ontology nodes, and 5 registry entries. Five contextual-only placements and five registry-only targets remain outside production scoring. No cognitive, respondent, psychometric, reliability/validity, invariance, empirical, or population evidence was run or implied.

## V88 specification delta — Agrarian Populism

Agrarian Populism is a provisional canonical historical micro target under `Populism`. Its canonical path is `Populism → Agrarian Populism`; its live measurement state is `dedicated-scored`, while governance remains `scored-provisional`. The target must remain bounded to a rural or land-based people–elite construction joined to land, food, agricultural production, or rural political power, and must preserve class-composition, rural–urban, country, period, cooperative, smallholder, farm-worker, peasant, progressive, reactionary, market, socialist, nationalist, and democratic variation.

The target must remain distinct from thin-core Populism, Left-Wing Populism, Right-Wing Populism, agrarian-class parties, Market Socialism, rural identity, farmer status, localism, food/land policy, tariffs, generic anti-elite sentiment, left/right host alone, current party affiliation, current actors, and private identity. It is historical and non-diagnostic; no respondent or current-actor inference is permitted.

The production contract is twelve source-linked prompts at descriptive/normative/prescriptive 4/4/4, eight direct source references, one provisional anchor, a source-linked 17-dimension profile, four neighbor discriminants, a false-positive audit, and a source-backed promotion decision. Effects must remain within their claim layer. Research candidates remain quarantined, and scorer policy version 3, picker/facet/threshold/distance semantics, combined-layer behavior, contextual-anchor exclusion, and compact-share compatibility remain unchanged. No cognitive review, respondent study, substitute simulation, psychometric validation, or empirical validation is included.
